...
public partial interface IWMDRMMessageParser
{
    ...
    HRESULT ParseRegistrationReqMsg(nint /* byte array */ pbRegistrationReqMsg, uint cbRegistrationReqMsg, out INSSBuffer ppDeviceCert, out DRM_VAL16 pDeviceSerialNumber);
    
    // https://learn.microsoft.com/windows/win32/api/wmsdkidl/nf-wmsdkidl-iwmdrmmessageparser-parselicenserequestmsg
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT ParseLicenseRequestMsg(nint /* byte array */ pbLicenseRequestMsg, uint cbLicenseRequestMsg, out INSSBuffer ppDeviceCert, out DRM_VAL16 pDeviceSerialNumber, out BSTR pbstrAction);
}
