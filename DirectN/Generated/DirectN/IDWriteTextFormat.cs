...
public partial interface IDWriteTextFormat
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetTrimming(out DWRITE_TRIMMING trimmingOptions, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDWriteInlineObject>))] out IDWriteInlineObject trimmingSign);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetFontFamilyName([MarshalUsing(CountElementName = nameof(nameSize))] PWSTR fontFamilyName, uint nameSize);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetLocaleName([MarshalUsing(CountElementName = nameof(nameSize))] PWSTR localeName, uint nameSize);
}
