...
public partial interface IXpsOMThumbnailGenerator
{
    ...
    HRESULT GenerateThumbnail([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IXpsOMPage>))] IXpsOMPage page, XPS_IMAGE_TYPE thumbnailType, XPS_THUMBNAIL_SIZE thumbnailSize, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IOpcPartUri>))] IOpcPartUri imageResourcePartName, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IXpsOMImageResource>))] out IXpsOMImageResource imageResource);
}
