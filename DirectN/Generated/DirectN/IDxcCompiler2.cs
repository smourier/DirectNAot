...
public partial interface IDxcCompiler2 : IDxcCompiler
{
    ...
    HRESULT CompileWithDebug(IDxcBlob pSource, PWSTR pSourceName, PWSTR pEntryPoint, PWSTR pTargetProfile, nint /* optional PWSTR* */ pArguments, uint argCount, [In][MarshalUsing(CountElementName = nameof(defineCount))] DxcDefine[] pDefines, uint defineCount, IDxcIncludeHandler? pIncludeHandler, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDxcOperationResult>))] out IDxcOperationResult ppResult, nint /* optional PWSTR* */ ppDebugBlobName, nint /* optional IDxcBlob* */ ppDebugBlob);
}
