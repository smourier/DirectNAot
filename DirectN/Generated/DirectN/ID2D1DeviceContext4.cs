...
public partial interface ID2D1DeviceContext4 : ID2D1DeviceContext3
{
    ...
    [PreserveSig]
    void DrawText([MarshalUsing(CountElementName = nameof(stringLength))] PWSTR @string, uint stringLength, IDWriteTextFormat textFormat, in D2D_RECT_F layoutRect, ID2D1Brush? defaultFillBrush, ID2D1SvgGlyphStyle? svgGlyphStyle, uint colorPaletteIndex, D2D1_DRAW_TEXT_OPTIONS options, DWRITE_MEASURING_MODE measuringMode);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetColorBitmapGlyphImage(DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat, D2D_POINT_2F glyphOrigin, IDWriteFontFace fontFace, float fontEmSize, ushort glyphIndex, BOOL isSideways, nint /* optional D2D_MATRIX_3X2_F* */ worldTransform, float dpiX, float dpiY, out D2D_MATRIX_3X2_F glyphTransform, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Image>))] out ID2D1Image glyphImage);
    
    // https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1devicecontext4-getsvgglyphimage
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetSvgGlyphImage(D2D_POINT_2F glyphOrigin, IDWriteFontFace fontFace, float fontEmSize, ushort glyphIndex, BOOL isSideways, nint /* optional D2D_MATRIX_3X2_F* */ worldTransform, ID2D1Brush? defaultFillBrush, ID2D1SvgGlyphStyle? svgGlyphStyle, uint colorPaletteIndex, out D2D_MATRIX_3X2_F glyphTransform, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1CommandList>))] out ID2D1CommandList glyphImage);
}
