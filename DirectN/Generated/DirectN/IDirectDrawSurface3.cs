...
public partial interface IDirectDrawSurface3
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT Blt(ref RECT param0, IDirectDrawSurface3 param1, ref RECT param2, uint param3, ref DDBLTFX param4);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT BltFast(uint param0, uint param1, IDirectDrawSurface3 param2, ref RECT param3, uint param4);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT UpdateOverlay(ref RECT param0, IDirectDrawSurface3 param1, ref RECT param2, uint param3, ref DDOVERLAYFX param4);
