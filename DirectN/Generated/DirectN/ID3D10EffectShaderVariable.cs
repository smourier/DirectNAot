...
public partial struct ID3D10EffectShaderVariable
{
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetShaderDesc(uint ShaderIndex, ref D3D10_EFFECT_SHADER_DESC pDesc)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectShaderVariable*,uint,D3D10_EFFECT_SHADER_DESC*, HRESULT>)(((void**)VTablePtr)[25]))((ID3D10EffectShaderVariable*)VTablePtr, ShaderIndex, (D3D10_EFFECT_SHADER_DESC*)Unsafe.AsPointer(ref pDesc));
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectshadervariable-getvertexshader
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetVertexShader(uint ShaderIndex, ref nint ppVS)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectShaderVariable*,uint,nint*, HRESULT>)(((void**)VTablePtr)[26]))((ID3D10EffectShaderVariable*)VTablePtr, ShaderIndex, (nint*)Unsafe.AsPointer(ref ppVS));
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectshadervariable-getgeometryshader
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetGeometryShader(uint ShaderIndex, ref nint ppGS)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectShaderVariable*,uint,nint*, HRESULT>)(((void**)VTablePtr)[27]))((ID3D10EffectShaderVariable*)VTablePtr, ShaderIndex, (nint*)Unsafe.AsPointer(ref ppGS));
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectshadervariable-getpixelshader
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetPixelShader(uint ShaderIndex, ref nint ppPS)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectShaderVariable*,uint,nint*, HRESULT>)(((void**)VTablePtr)[28]))((ID3D10EffectShaderVariable*)VTablePtr, ShaderIndex, (nint*)Unsafe.AsPointer(ref ppPS));
    }
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetInputSignatureElementDesc(uint ShaderIndex, uint Element, ref D3D10_SIGNATURE_PARAMETER_DESC pDesc)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectShaderVariable*,uint,uint,D3D10_SIGNATURE_PARAMETER_DESC*, HRESULT>)(((void**)VTablePtr)[29]))((ID3D10EffectShaderVariable*)VTablePtr, ShaderIndex, Element, (D3D10_SIGNATURE_PARAMETER_DESC*)Unsafe.AsPointer(ref pDesc));
    }
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetOutputSignatureElementDesc(uint ShaderIndex, uint Element, ref D3D10_SIGNATURE_PARAMETER_DESC pDesc)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectShaderVariable*,uint,uint,D3D10_SIGNATURE_PARAMETER_DESC*, HRESULT>)(((void**)VTablePtr)[30]))((ID3D10EffectShaderVariable*)VTablePtr, ShaderIndex, Element, (D3D10_SIGNATURE_PARAMETER_DESC*)Unsafe.AsPointer(ref pDesc));
    }
}
