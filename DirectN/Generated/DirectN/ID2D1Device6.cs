...
public partial interface ID2D1Device6 : ID2D1Device5
{
    ...
    HRESULT CreateDeviceContext(D2D1_DEVICE_CONTEXT_OPTIONS options, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1DeviceContext6>))] out ID2D1DeviceContext6 deviceContext6);
}
