...
public partial struct D3D10_TEX2D_RTV : IEquatable<D3D10_TEX2D_RTV>
{
    ...
    public D3D10_TEX2D_RTV(uint value) => this.MipSlice = value;
    public override string ToString() => $"0x{MipSlice:x}";
    
    public override readonly bool Equals(object? obj) => obj is D3D10_TEX2D_RTV value && Equals(value);
    public readonly bool Equals(D3D10_TEX2D_RTV other) => other.MipSlice == MipSlice;
