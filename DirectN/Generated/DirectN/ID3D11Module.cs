...
public partial interface ID3D11Module
{
    ...
    HRESULT CreateInstance(PSTR pNamespace, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D11ModuleInstance>))] out ID3D11ModuleInstance ppModuleInstance);
}
