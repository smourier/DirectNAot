...
public partial interface IWMPropertyVault
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetPropertyByIndex(uint dwIndex, [MarshalUsing(CountElementName = nameof(pdwNameLen))] PWSTR pszName, ref uint pdwNameLen, out WMT_ATTR_DATATYPE pType, nint /* byte array */ pValue, ref uint pdwSize);
