...
public partial interface IMFMetadataProvider
{
    ...
    HRESULT GetMFMetadata([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IMFPresentationDescriptor?>))] IMFPresentationDescriptor? pPresentationDescriptor, uint dwStreamIdentifier, uint dwFlags, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IMFMetadata>))] out IMFMetadata ppMFMetadata);
}
