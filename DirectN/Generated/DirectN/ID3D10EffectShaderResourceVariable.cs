...
public partial struct ID3D10EffectShaderResourceVariable
{
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetResource(ID3D10ShaderResourceView? pResource)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectShaderResourceVariable*,ID3D10ShaderResourceView?, HRESULT>)(((void**)VTablePtr)[25]))((ID3D10EffectShaderResourceVariable*)VTablePtr, pResource);
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectshaderresourcevariable-getresource
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetResource(ref nint ppResource)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectShaderResourceVariable*,nint*, HRESULT>)(((void**)VTablePtr)[26]))((ID3D10EffectShaderResourceVariable*)VTablePtr, (nint*)Unsafe.AsPointer(ref ppResource));
    }
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetResourceArray([In][MarshalUsing(CountElementName = nameof(Count))] ID3D10ShaderResourceView[] ppResources, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectShaderResourceVariable*,ID3D10ShaderResourceView[],uint,uint, HRESULT>)(((void**)VTablePtr)[27]))((ID3D10EffectShaderResourceVariable*)VTablePtr, ppResources, Offset, Count);
    }
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetResourceArray([In][Out][MarshalUsing(CountElementName = nameof(Count))] ID3D10ShaderResourceView[] ppResources, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectShaderResourceVariable*,ID3D10ShaderResourceView[],uint,uint, HRESULT>)(((void**)VTablePtr)[28]))((ID3D10EffectShaderResourceVariable*)VTablePtr, ppResources, Offset, Count);
    }
}
