...
{
    public static readonly ID3D10EffectShaderResourceVariable Null = new();
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetResource(ref nint ppResource) =>
        ((delegate* unmanaged<ID3D10EffectShaderResourceVariable*,nint*, HRESULT>)(((void**)*((void**)VTablePtr))[26]))((ID3D10EffectShaderResourceVariable*)VTablePtr, (nint*)Unsafe.AsPointer(ref ppResource));
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT SetResourceArray([In][MarshalUsing(CountElementName = nameof(Count))] ID3D10ShaderResourceView[] ppResources, uint Offset, uint Count) =>
        ((delegate* unmanaged<ID3D10EffectShaderResourceVariable*,ID3D10ShaderResourceView[],uint,uint, HRESULT>)(((void**)*((void**)VTablePtr))[27]))((ID3D10EffectShaderResourceVariable*)VTablePtr, ppResources, Offset, Count);
