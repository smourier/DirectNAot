...
public partial interface IPrintDocumentPackageTargetFactory
{
    ...
    HRESULT CreateDocumentPackageTargetForPrintJob(PWSTR printerName, PWSTR jobName, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IStream>))] IStream jobOutputStream, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IStream>))] IStream jobPrintTicketStream, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IPrintDocumentPackageTarget>))] out IPrintDocumentPackageTarget docPackageTarget);
}
