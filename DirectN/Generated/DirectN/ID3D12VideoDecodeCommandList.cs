...
public partial interface ID3D12VideoDecodeCommandList : ID3D12CommandList
{
    ...
    [PreserveSig]
    void DecodeFrame([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D12VideoDecoder>))] ID3D12VideoDecoder pDecoder, in D3D12_VIDEO_DECODE_OUTPUT_STREAM_ARGUMENTS pOutputArguments, in D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS pInputArguments);
