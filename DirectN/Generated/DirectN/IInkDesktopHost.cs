...
public partial interface IInkDesktopHost
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateInkPresenter(in Guid riid, out nint /* void */ ppv);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateAndInitializeInkPresenter(nint rootVisual, float width, float height, in Guid riid, out nint /* void */ ppv);
}
