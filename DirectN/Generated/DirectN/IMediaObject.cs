...
public partial interface IMediaObject
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT ProcessOutput(uint dwFlags, uint cOutputBufferCount, [In][Out][MarshalUsing(CountElementName = nameof(cOutputBufferCount))] DMO_OUTPUT_DATA_BUFFER[] pOutputBuffers, out uint pdwStatus);
