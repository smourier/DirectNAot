...
public partial interface IMFSensorTransformFactory
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT InitializeFactory(uint dwMaxTransformCount, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IMFCollection>))] IMFCollection pSensorDevices, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IMFAttributes?>))] IMFAttributes? pAttributes);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateTransform(in Guid guidSensorTransformID, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IMFAttributes?>))] IMFAttributes? pAttributes, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IMFDeviceTransform>))] out IMFDeviceTransform ppDeviceMFT);
}
