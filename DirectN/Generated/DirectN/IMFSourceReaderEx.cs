...
public partial interface IMFSourceReaderEx : IMFSourceReader
{
    ...
    HRESULT SetNativeMediaType(uint dwStreamIndex, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IMFMediaType?>))] IMFMediaType? pMediaType, out uint pdwStreamFlags);
