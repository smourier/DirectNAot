...
public partial interface ID3D12VideoEncodeCommandList : ID3D12CommandList
{
    ...
    [PreserveSig]
    void EstimateMotion([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D12VideoMotionEstimator>))] ID3D12VideoMotionEstimator pMotionEstimator, in D3D12_VIDEO_MOTION_ESTIMATOR_OUTPUT pOutputArguments, in D3D12_VIDEO_MOTION_ESTIMATOR_INPUT pInputArguments);
