...
public partial interface IWMClientConnections2 : IWMClientConnections
{
    ...
    HRESULT GetClientInfo(uint dwClientNum, [MarshalUsing(CountElementName = nameof(pcchNetworkAddress))] PWSTR pwszNetworkAddress, ref uint pcchNetworkAddress, [MarshalUsing(CountElementName = nameof(pcchPort))] PWSTR pwszPort, ref uint pcchPort, [MarshalUsing(CountElementName = nameof(pcchDNSName))] PWSTR pwszDNSName, ref uint pcchDNSName);
}
