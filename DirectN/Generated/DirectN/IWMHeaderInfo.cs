...
public partial interface IWMHeaderInfo
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetAttributeByIndex(ushort wIndex, ref ushort pwStreamNum, [MarshalUsing(CountElementName = nameof(pcchNameLen))] PWSTR pwszName, ref ushort pcchNameLen, out WMT_ATTR_DATATYPE pType, nint /* byte array */ pValue, ref ushort pcbLength);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetMarker(ushort wIndex, [MarshalUsing(CountElementName = nameof(pcchMarkerNameLen))] PWSTR pwszMarkerName, ref ushort pcchMarkerNameLen, out ulong pcnsMarkerTime);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetScript(ushort wIndex, [MarshalUsing(CountElementName = nameof(pcchTypeLen))] PWSTR pwszType, ref ushort pcchTypeLen, [MarshalUsing(CountElementName = nameof(pcchCommandLen))] PWSTR pwszCommand, ref ushort pcchCommandLen, out ulong pcnsScriptTime);
