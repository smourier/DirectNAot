...
public partial interface IWMHeaderInfo2 : IWMHeaderInfo
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetCodecInfo(uint wIndex, ref ushort pcchName, [MarshalUsing(CountElementName = nameof(pcchName))] PWSTR pwszName, ref ushort pcchDescription, [MarshalUsing(CountElementName = nameof(pcchDescription))] PWSTR pwszDescription, out WMT_CODEC_INFO_TYPE pCodecType, ref ushort pcbCodecInfo, nint /* byte array */ pbCodecInfo);
}
