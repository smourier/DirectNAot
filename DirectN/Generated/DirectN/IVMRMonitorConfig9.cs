...
public partial interface IVMRMonitorConfig9
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetAvailableMonitors([In][Out][MarshalUsing(CountElementName = nameof(dwMaxInfoArraySize))] VMR9MonitorInfo[] pInfo, uint dwMaxInfoArraySize, out uint pdwNumDevices);
}
