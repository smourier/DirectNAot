...
public partial struct ID3D10EffectStringVariable
{
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetString(ref PSTR ppString)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectStringVariable*,PSTR*, HRESULT>)(((void**)VTablePtr)[25]))((ID3D10EffectStringVariable*)VTablePtr, (PSTR*)Unsafe.AsPointer(ref ppString));
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectstringvariable-getstringarray
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetStringArray([In][Out][MarshalUsing(CountElementName = nameof(Count))] PSTR[] ppStrings, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectStringVariable*,PSTR[],uint,uint, HRESULT>)(((void**)VTablePtr)[26]))((ID3D10EffectStringVariable*)VTablePtr, ppStrings, Offset, Count);
    }
}
