...
public partial struct ID3D10EffectStringVariable
{
    public static readonly ID3D10EffectStringVariable Null = new();
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetString(ref PSTR ppString) =>
        ((delegate* unmanaged<ID3D10EffectStringVariable*,PSTR*, HRESULT>)(((void**)*((void**)VTablePtr))[25]))((ID3D10EffectStringVariable*)VTablePtr, (PSTR*)Unsafe.AsPointer(ref ppString));
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectstringvariable-getstringarray
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetStringArray([In][Out][MarshalUsing(CountElementName = nameof(Count))] PSTR[] ppStrings, uint Offset, uint Count) =>
        ((delegate* unmanaged<ID3D10EffectStringVariable*,PSTR[],uint,uint, HRESULT>)(((void**)*((void**)VTablePtr))[26]))((ID3D10EffectStringVariable*)VTablePtr, ppStrings, Offset, Count);
}
