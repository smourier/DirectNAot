...
public partial interface ID3DX11SegmentedScan
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT SegScan(D3DX11_SCAN_DATA_TYPE ElementType, D3DX11_SCAN_OPCODE OpCode, uint ElementScanSize, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D11UnorderedAccessView?>))] ID3D11UnorderedAccessView? pSrc, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D11UnorderedAccessView>))] ID3D11UnorderedAccessView pSrcElementFlags, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D11UnorderedAccessView>))] ID3D11UnorderedAccessView pDst);
}
