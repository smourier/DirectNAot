...
public partial interface IWICImagingFactory
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateDecoderFromStream([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IStream>))] IStream pIStream, in Guid pguidVendor, WICDecodeOptions metadataOptions, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IWICBitmapDecoder>))] out IWICBitmapDecoder ppIDecoder);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateBitmapFromSource([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IWICBitmapSource>))] IWICBitmapSource pIBitmapSource, WICBitmapCreateCacheOption option, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IWICBitmap>))] out IWICBitmap ppIBitmap);
    
    // https://learn.microsoft.com/windows/win32/api/wincodec/nf-wincodec-iwicimagingfactory-createbitmapfromsourcerect
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateBitmapFromSourceRect([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IWICBitmapSource>))] IWICBitmapSource pIBitmapSource, uint x, uint y, uint width, uint height, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IWICBitmap>))] out IWICBitmap ppIBitmap);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateFastMetadataEncoderFromDecoder([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IWICBitmapDecoder>))] IWICBitmapDecoder pIDecoder, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IWICFastMetadataEncoder>))] out IWICFastMetadataEncoder ppIFastEncoder);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateFastMetadataEncoderFromFrameDecode([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IWICBitmapFrameDecode>))] IWICBitmapFrameDecode pIFrameDecoder, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IWICFastMetadataEncoder>))] out IWICFastMetadataEncoder ppIFastEncoder);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateQueryWriterFromReader([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IWICMetadataQueryReader>))] IWICMetadataQueryReader pIQueryReader, in Guid pguidVendor, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IWICMetadataQueryWriter>))] out IWICMetadataQueryWriter ppIQueryWriter);
}
