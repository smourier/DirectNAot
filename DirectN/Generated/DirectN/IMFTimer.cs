...
public partial interface IMFTimer
{
    ...
    HRESULT SetTimer(uint dwFlags, long llClockTime, IMFAsyncCallback pCallback, nint punkState, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<nint>))] out nint ppunkKey);
