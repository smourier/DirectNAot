...
public partial struct ID3D10EffectSamplerVariable
{
    public static readonly ID3D10EffectSamplerVariable Null = new();
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetSampler(uint Index, ref nint ppSampler) =>
        ((delegate* unmanaged<ID3D10EffectSamplerVariable*,uint,nint*, HRESULT>)(((void**)*((void**)VTablePtr))[25]))((ID3D10EffectSamplerVariable*)VTablePtr, Index, (nint*)Unsafe.AsPointer(ref ppSampler));
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectsamplervariable-getbackingstore
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetBackingStore(uint Index, ref D3D10_SAMPLER_DESC pSamplerDesc) =>
        ((delegate* unmanaged<ID3D10EffectSamplerVariable*,uint,D3D10_SAMPLER_DESC*, HRESULT>)(((void**)*((void**)VTablePtr))[26]))((ID3D10EffectSamplerVariable*)VTablePtr, Index, (D3D10_SAMPLER_DESC*)Unsafe.AsPointer(ref pSamplerDesc));
}
