...
public partial struct IXAudio2MasteringVoice
{
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetChannelMask(ref uint pChannelmask)
    {
        return ((delegate* unmanaged[MemberFunction]<IXAudio2MasteringVoice*,uint*, HRESULT>)(((void**)VTablePtr)[19]))((IXAudio2MasteringVoice*)VTablePtr, (uint*)Unsafe.AsPointer(ref pChannelmask));
    }
}
