...
{
    public static readonly IXAudio2MasteringVoice Null = new();
    ...
    public readonly unsafe HRESULT GetChannelMask(ref uint pChannelmask) =>
        ((delegate* unmanaged<IXAudio2MasteringVoice*,uint*, HRESULT>)(((void**)*((void**)VTablePtr))[19]))((IXAudio2MasteringVoice*)VTablePtr, (uint*)Unsafe.AsPointer(ref pChannelmask));
}
