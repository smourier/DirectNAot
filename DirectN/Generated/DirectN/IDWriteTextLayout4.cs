...
public partial interface IDWriteTextLayout4 : IDWriteTextLayout3
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetFontAxisValues(uint currentPosition, [In][Out][MarshalUsing(CountElementName = nameof(fontAxisValueCount))] DWRITE_FONT_AXIS_VALUE[] fontAxisValues, uint fontAxisValueCount, nint /* optional DWRITE_TEXT_RANGE* */ textRange);
