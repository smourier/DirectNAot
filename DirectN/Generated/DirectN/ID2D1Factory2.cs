...
public partial interface ID2D1Factory2 : ID2D1Factory1
{
    ...
    HRESULT CreateDevice([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDXGIDevice>))] IDXGIDevice dxgiDevice, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Device1>))] out ID2D1Device1 d2dDevice1);
}
