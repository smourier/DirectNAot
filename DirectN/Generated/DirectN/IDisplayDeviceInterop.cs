...
public partial interface IDisplayDeviceInterop
{
    ...
    HRESULT CreateSharedHandle([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IInspectable>))] IInspectable pObject, in SECURITY_ATTRIBUTES pSecurityAttributes, uint Access, HSTRING Name, out HANDLE pHandle);
