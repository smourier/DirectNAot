...
public partial struct ID3D10EffectDepthStencilViewVariable
{
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetDepthStencil(ID3D10DepthStencilView? pResource)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectDepthStencilViewVariable*,ID3D10DepthStencilView?, HRESULT>)(((void**)VTablePtr)[25]))((ID3D10EffectDepthStencilViewVariable*)VTablePtr, pResource);
    }
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetDepthStencil(ref nint ppResource)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectDepthStencilViewVariable*,nint*, HRESULT>)(((void**)VTablePtr)[26]))((ID3D10EffectDepthStencilViewVariable*)VTablePtr, (nint*)Unsafe.AsPointer(ref ppResource));
    }
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetDepthStencilArray([In][MarshalUsing(CountElementName = nameof(Count))] ID3D10DepthStencilView[] ppResources, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectDepthStencilViewVariable*,ID3D10DepthStencilView[],uint,uint, HRESULT>)(((void**)VTablePtr)[27]))((ID3D10EffectDepthStencilViewVariable*)VTablePtr, ppResources, Offset, Count);
    }
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetDepthStencilArray([In][Out][MarshalUsing(CountElementName = nameof(Count))] ID3D10DepthStencilView[] ppResources, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectDepthStencilViewVariable*,ID3D10DepthStencilView[],uint,uint, HRESULT>)(((void**)VTablePtr)[28]))((ID3D10EffectDepthStencilViewVariable*)VTablePtr, ppResources, Offset, Count);
    }
}
