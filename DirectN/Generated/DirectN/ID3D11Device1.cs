...
public partial interface ID3D11Device1 : ID3D11Device
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT OpenSharedResource1(HANDLE hResource, in Guid returnedInterface, out nint /* void */ ppResource);
    
    // https://learn.microsoft.com/windows/win32/api/d3d11_1/nf-d3d11_1-id3d11device1-opensharedresourcebyname
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT OpenSharedResourceByName(PWSTR lpName, uint dwDesiredAccess, in Guid returnedInterface, out nint /* void */ ppResource);
}
