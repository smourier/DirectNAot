...
public partial interface ID3D11DeviceContext2 : ID3D11DeviceContext1
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT ResizeTilePool([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D11Buffer>))] ID3D11Buffer pTilePool, ulong NewSizeInBytes);
