...
public partial interface IWMLanguageList
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetLanguageDetails(ushort wIndex, [MarshalUsing(CountElementName = nameof(pcchLanguageStringLength))] PWSTR pwszLanguageString, ref ushort pcchLanguageStringLength);
