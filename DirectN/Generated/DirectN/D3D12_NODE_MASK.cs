...
public partial struct D3D12_NODE_MASK : IEquatable<D3D12_NODE_MASK>, IValueGet<uint>
{
    ...
    public override readonly string ToString() => $"0x{NodeMask:x}";
    ...
    readonly uint IValueGet<uint>.GetValue() => NodeMask;
    readonly object? IValueGet.GetValue() => NodeMask;
}
