...
{
    public static readonly ID3D10EffectRenderTargetViewVariable Null = new();
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetRenderTarget(ref nint ppResource) =>
        ((delegate* unmanaged<ID3D10EffectRenderTargetViewVariable*,nint*, HRESULT>)(((void**)*((void**)VTablePtr))[26]))((ID3D10EffectRenderTargetViewVariable*)VTablePtr, (nint*)Unsafe.AsPointer(ref ppResource));
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT SetRenderTargetArray([In][MarshalUsing(CountElementName = nameof(Count))] ID3D10RenderTargetView[] ppResources, uint Offset, uint Count) =>
        ((delegate* unmanaged<ID3D10EffectRenderTargetViewVariable*,ID3D10RenderTargetView[],uint,uint, HRESULT>)(((void**)*((void**)VTablePtr))[27]))((ID3D10EffectRenderTargetViewVariable*)VTablePtr, ppResources, Offset, Count);
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetRenderTargetArray([In][Out][MarshalUsing(CountElementName = nameof(Count))] ID3D10RenderTargetView[] ppResources, uint Offset, uint Count) =>
        ((delegate* unmanaged<ID3D10EffectRenderTargetViewVariable*,ID3D10RenderTargetView[],uint,uint, HRESULT>)(((void**)*((void**)VTablePtr))[28]))((ID3D10EffectRenderTargetViewVariable*)VTablePtr, ppResources, Offset, Count);
}
