...
public partial interface IDirectXVideoProcessor
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT VideoProcessBlt([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDirect3DSurface9>))] IDirect3DSurface9 pRenderTarget, in DXVA2_VideoProcessBltParams pBltParams, [In][MarshalUsing(CountElementName = nameof(NumSamples))] MediaFoundationDXVA2_VideoSample[] pSamples, uint NumSamples, nint /* optional HANDLE* */ pHandleComplete);
}
