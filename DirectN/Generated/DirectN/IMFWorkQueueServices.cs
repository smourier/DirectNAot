...
public partial interface IMFWorkQueueServices
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetTopologyWorkQueueMMCSSClass(uint dwTopologyWorkQueueId, [MarshalUsing(CountElementName = nameof(pcchClass))] PWSTR pwszClass, ref uint pcchClass);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetPlaftormWorkQueueMMCSSClass(uint dwPlatformWorkQueueId, [MarshalUsing(CountElementName = nameof(pcchClass))] PWSTR pwszClass, ref uint pcchClass);
