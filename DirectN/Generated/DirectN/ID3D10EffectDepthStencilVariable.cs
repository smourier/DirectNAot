...
public partial struct ID3D10EffectDepthStencilVariable
{
    public static readonly ID3D10EffectDepthStencilVariable Null = new();
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetDepthStencilState(uint Index, ref nint ppDepthStencilState) =>
        ((delegate* unmanaged<ID3D10EffectDepthStencilVariable*,uint,nint*, HRESULT>)(((void**)*((void**)VTablePtr))[25]))((ID3D10EffectDepthStencilVariable*)VTablePtr, Index, (nint*)Unsafe.AsPointer(ref ppDepthStencilState));
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectdepthstencilvariable-getbackingstore
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetBackingStore(uint Index, ref D3D10_DEPTH_STENCIL_DESC pDepthStencilDesc) =>
        ((delegate* unmanaged<ID3D10EffectDepthStencilVariable*,uint,D3D10_DEPTH_STENCIL_DESC*, HRESULT>)(((void**)*((void**)VTablePtr))[26]))((ID3D10EffectDepthStencilVariable*)VTablePtr, Index, (D3D10_DEPTH_STENCIL_DESC*)Unsafe.AsPointer(ref pDepthStencilDesc));
}
