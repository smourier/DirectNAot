...
public partial interface ID3D10EffectDepthStencilVariable : ID3D10EffectVariable
{
    ...
    HRESULT GetDepthStencilState(uint Index, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D10DepthStencilState>))] out ID3D10DepthStencilState ppDepthStencilState);
