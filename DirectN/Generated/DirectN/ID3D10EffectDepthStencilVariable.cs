...
public partial struct ID3D10EffectDepthStencilVariable
{
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetDepthStencilState(uint Index, ref nint ppDepthStencilState)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectDepthStencilVariable*,uint,nint*, HRESULT>)(((void**)VTablePtr)[25]))((ID3D10EffectDepthStencilVariable*)VTablePtr, Index, (nint*)Unsafe.AsPointer(ref ppDepthStencilState));
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectdepthstencilvariable-getbackingstore
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetBackingStore(uint Index, ref D3D10_DEPTH_STENCIL_DESC pDepthStencilDesc)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectDepthStencilVariable*,uint,D3D10_DEPTH_STENCIL_DESC*, HRESULT>)(((void**)VTablePtr)[26]))((ID3D10EffectDepthStencilVariable*)VTablePtr, Index, (D3D10_DEPTH_STENCIL_DESC*)Unsafe.AsPointer(ref pDepthStencilDesc));
    }
}
