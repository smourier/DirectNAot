...
public partial interface IDXGIFactory2 : IDXGIFactory1
{
    ...
    HRESULT CreateSwapChainForHwnd(nint pDevice, HWND hWnd, in DXGI_SWAP_CHAIN_DESC1 pDesc, nint /* optional DXGI_SWAP_CHAIN_FULLSCREEN_DESC* */ pFullscreenDesc, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDXGIOutput?>))] IDXGIOutput? pRestrictToOutput, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDXGISwapChain1>))] out IDXGISwapChain1 ppSwapChain);
    
    // https://learn.microsoft.com/windows/win32/api/dxgi1_2/nf-dxgi1_2-idxgifactory2-createswapchainforcorewindow
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateSwapChainForCoreWindow(nint pDevice, nint pWindow, in DXGI_SWAP_CHAIN_DESC1 pDesc, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDXGIOutput?>))] IDXGIOutput? pRestrictToOutput, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDXGISwapChain1>))] out IDXGISwapChain1 ppSwapChain);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateSwapChainForComposition(nint pDevice, in DXGI_SWAP_CHAIN_DESC1 pDesc, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDXGIOutput?>))] IDXGIOutput? pRestrictToOutput, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDXGISwapChain1>))] out IDXGISwapChain1 ppSwapChain);
}
