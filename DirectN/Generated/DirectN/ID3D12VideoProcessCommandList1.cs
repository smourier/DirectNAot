...
public partial interface ID3D12VideoProcessCommandList1 : ID3D12VideoProcessCommandList
{
    ...
    [PreserveSig]
    void ProcessFrames1([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D12VideoProcessor>))] ID3D12VideoProcessor pVideoProcessor, in D3D12_VIDEO_PROCESS_OUTPUT_STREAM_ARGUMENTS pOutputArguments, uint NumInputStreams, [In][MarshalUsing(CountElementName = nameof(NumInputStreams))] D3D12_VIDEO_PROCESS_INPUT_STREAM_ARGUMENTS1[] pInputArguments);
}
