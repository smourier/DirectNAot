...
public partial struct ID3D10EffectScalarVariable
{
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetFloat(float Value)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectScalarVariable*,float, HRESULT>)(((void**)VTablePtr)[25]))((ID3D10EffectScalarVariable*)VTablePtr, Value);
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectscalarvariable-getfloat
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetFloat(ref float pValue)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectScalarVariable*,float*, HRESULT>)(((void**)VTablePtr)[26]))((ID3D10EffectScalarVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pValue));
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectscalarvariable-setfloatarray
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetFloatArray([In][MarshalUsing(CountElementName = nameof(Count))] float[] pData, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectScalarVariable*,float[],uint,uint, HRESULT>)(((void**)VTablePtr)[27]))((ID3D10EffectScalarVariable*)VTablePtr, pData, Offset, Count);
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectscalarvariable-getfloatarray
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetFloatArray([In][Out][MarshalUsing(CountElementName = nameof(Count))] float[] pData, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectScalarVariable*,float[],uint,uint, HRESULT>)(((void**)VTablePtr)[28]))((ID3D10EffectScalarVariable*)VTablePtr, pData, Offset, Count);
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectscalarvariable-setint
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetInt(int Value)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectScalarVariable*,int, HRESULT>)(((void**)VTablePtr)[29]))((ID3D10EffectScalarVariable*)VTablePtr, Value);
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectscalarvariable-getint
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetInt(ref int pValue)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectScalarVariable*,int*, HRESULT>)(((void**)VTablePtr)[30]))((ID3D10EffectScalarVariable*)VTablePtr, (int*)Unsafe.AsPointer(ref pValue));
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectscalarvariable-setintarray
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetIntArray([In][MarshalUsing(CountElementName = nameof(Count))] int[] pData, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectScalarVariable*,int[],uint,uint, HRESULT>)(((void**)VTablePtr)[31]))((ID3D10EffectScalarVariable*)VTablePtr, pData, Offset, Count);
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectscalarvariable-getintarray
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetIntArray([In][Out][MarshalUsing(CountElementName = nameof(Count))] int[] pData, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectScalarVariable*,int[],uint,uint, HRESULT>)(((void**)VTablePtr)[32]))((ID3D10EffectScalarVariable*)VTablePtr, pData, Offset, Count);
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectscalarvariable-setbool
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetBool(BOOL Value)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectScalarVariable*,BOOL, HRESULT>)(((void**)VTablePtr)[33]))((ID3D10EffectScalarVariable*)VTablePtr, Value);
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectscalarvariable-getbool
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetBool(ref BOOL pValue)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectScalarVariable*,BOOL*, HRESULT>)(((void**)VTablePtr)[34]))((ID3D10EffectScalarVariable*)VTablePtr, (BOOL*)Unsafe.AsPointer(ref pValue));
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectscalarvariable-setboolarray
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetBoolArray([In][MarshalUsing(CountElementName = nameof(Count))] BOOL[] pData, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectScalarVariable*,BOOL[],uint,uint, HRESULT>)(((void**)VTablePtr)[35]))((ID3D10EffectScalarVariable*)VTablePtr, pData, Offset, Count);
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectscalarvariable-getboolarray
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetBoolArray([In][Out][MarshalUsing(CountElementName = nameof(Count))] BOOL[] pData, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectScalarVariable*,BOOL[],uint,uint, HRESULT>)(((void**)VTablePtr)[36]))((ID3D10EffectScalarVariable*)VTablePtr, pData, Offset, Count);
    }
}
