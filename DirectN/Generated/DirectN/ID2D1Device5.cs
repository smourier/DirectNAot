...
public partial interface ID2D1Device5 : ID2D1Device4
{
    ...
    HRESULT CreateDeviceContext(D2D1_DEVICE_CONTEXT_OPTIONS options, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1DeviceContext5>))] out ID2D1DeviceContext5 deviceContext5);
}
