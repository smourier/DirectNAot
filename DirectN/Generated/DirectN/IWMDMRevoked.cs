...
public partial interface IWMDMRevoked
{
    ...
    HRESULT GetRevocationURL([MarshalUsing(CountElementName = nameof(pdwBufferLen))] out PWSTR[] ppwszRevocationURL, ref uint pdwBufferLen, out uint pdwRevokedBitFlag);
}
