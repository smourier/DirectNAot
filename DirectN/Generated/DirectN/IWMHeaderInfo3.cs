...
public partial interface IWMHeaderInfo3 : IWMHeaderInfo2
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetAttributeByIndexEx(ushort wStreamNum, ushort wIndex, [MarshalUsing(CountElementName = nameof(pwNameLen))] PWSTR pwszName, ref ushort pwNameLen, out WMT_ATTR_DATATYPE pType, out ushort pwLangIndex, nint /* byte array */ pValue, ref uint pdwDataLength);
