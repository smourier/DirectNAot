...
{
    public static readonly ID3D10EffectConstantBuffer Null = new();
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetConstantBuffer(ref nint ppConstantBuffer) =>
        ((delegate* unmanaged<ID3D10EffectConstantBuffer*,nint*, HRESULT>)(((void**)*((void**)VTablePtr))[26]))((ID3D10EffectConstantBuffer*)VTablePtr, (nint*)Unsafe.AsPointer(ref ppConstantBuffer));
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetTextureBuffer(ref nint ppTextureBuffer) =>
        ((delegate* unmanaged<ID3D10EffectConstantBuffer*,nint*, HRESULT>)(((void**)*((void**)VTablePtr))[28]))((ID3D10EffectConstantBuffer*)VTablePtr, (nint*)Unsafe.AsPointer(ref ppTextureBuffer));
}
