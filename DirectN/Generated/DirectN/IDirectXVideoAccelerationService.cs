...
public partial interface IDirectXVideoAccelerationService
{
    ...
    HRESULT CreateSurface(uint Width, uint Height, uint BackBuffers, D3DFORMAT Format, D3DPOOL Pool, uint Usage, uint DxvaType, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDirect3DSurface9>))] out IDirect3DSurface9 ppSurface, nint /* optional HANDLE* */ pSharedHandle);
}
