...
public partial interface ID3D12VideoProcessor : ID3D12Pageable
{
    ...
    HRESULT GetInputStreamDescs(uint NumInputStreamDescs, [In][Out][MarshalUsing(CountElementName = nameof(NumInputStreamDescs))] D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC[] pInputStreamDescs);
