...
public partial interface ID3D12Device3 : ID3D12Device2
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT EnqueueMakeResident(D3D12_RESIDENCY_FLAGS Flags, uint NumObjects, [In][MarshalUsing(CountElementName = nameof(NumObjects))] ID3D12Pageable[] ppObjects, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D12Fence>))] ID3D12Fence pFenceToSignal, ulong FenceValueToSignal);
}
