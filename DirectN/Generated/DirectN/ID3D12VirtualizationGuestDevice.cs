...
public partial interface ID3D12VirtualizationGuestDevice
{
    ...
    HRESULT ShareWithHost([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D12DeviceChild>))] ID3D12DeviceChild pObject, out HANDLE pHandle);
    
    // https://learn.microsoft.com/windows/win32/api/d3d12/nf-d3d12-id3d12virtualizationguestdevice-createfencefd
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateFenceFd([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D12Fence>))] ID3D12Fence pFence, ulong FenceValue, out int pFenceFd);
}
