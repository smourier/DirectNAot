...
public partial interface ID2D1Factory5 : ID2D1Factory4
{
    ...
    HRESULT CreateDevice([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDXGIDevice>))] IDXGIDevice dxgiDevice, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID2D1Device4>))] out ID2D1Device4 d2dDevice4);
}
