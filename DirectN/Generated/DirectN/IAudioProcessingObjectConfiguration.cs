...
public partial interface IAudioProcessingObjectConfiguration
{
    ...
    HRESULT LockForProcess(uint u32NumInputConnections, [In][MarshalUsing(CountElementName = nameof(u32NumInputConnections))] APO_CONNECTION_DESCRIPTOR[] ppInputConnections, uint u32NumOutputConnections, [In][MarshalUsing(CountElementName = nameof(u32NumOutputConnections))] APO_CONNECTION_DESCRIPTOR[] ppOutputConnections);
