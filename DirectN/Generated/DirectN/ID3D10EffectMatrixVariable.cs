...
public partial struct ID3D10EffectMatrixVariable
{
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetMatrix(ref float pData)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectMatrixVariable*,float*, HRESULT>)(((void**)VTablePtr)[25]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData));
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectmatrixvariable-getmatrix
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetMatrix(ref float pData)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectMatrixVariable*,float*, HRESULT>)(((void**)VTablePtr)[26]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData));
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectmatrixvariable-setmatrixarray
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetMatrixArray(ref float pData, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectMatrixVariable*,float*,uint,uint, HRESULT>)(((void**)VTablePtr)[27]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData), Offset, Count);
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectmatrixvariable-getmatrixarray
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetMatrixArray(ref float pData, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectMatrixVariable*,float*,uint,uint, HRESULT>)(((void**)VTablePtr)[28]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData), Offset, Count);
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectmatrixvariable-setmatrixtranspose
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetMatrixTranspose(ref float pData)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectMatrixVariable*,float*, HRESULT>)(((void**)VTablePtr)[29]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData));
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectmatrixvariable-getmatrixtranspose
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetMatrixTranspose(ref float pData)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectMatrixVariable*,float*, HRESULT>)(((void**)VTablePtr)[30]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData));
    }
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT SetMatrixTransposeArray(ref float pData, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectMatrixVariable*,float*,uint,uint, HRESULT>)(((void**)VTablePtr)[31]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData), Offset, Count);
    }
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetMatrixTransposeArray(ref float pData, uint Offset, uint Count)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectMatrixVariable*,float*,uint,uint, HRESULT>)(((void**)VTablePtr)[32]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData), Offset, Count);
    }
}
