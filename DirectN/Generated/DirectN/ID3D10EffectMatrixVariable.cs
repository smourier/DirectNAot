...
{
    public static readonly ID3D10EffectMatrixVariable Null = new();
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT SetMatrix(ref float pData) =>
        ((delegate* unmanaged<ID3D10EffectMatrixVariable*,float*, HRESULT>)(((void**)*((void**)VTablePtr))[25]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData));
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectmatrixvariable-getmatrix
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetMatrix(ref float pData) =>
        ((delegate* unmanaged<ID3D10EffectMatrixVariable*,float*, HRESULT>)(((void**)*((void**)VTablePtr))[26]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData));
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectmatrixvariable-setmatrixarray
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT SetMatrixArray(ref float pData, uint Offset, uint Count) =>
        ((delegate* unmanaged<ID3D10EffectMatrixVariable*,float*,uint,uint, HRESULT>)(((void**)*((void**)VTablePtr))[27]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData), Offset, Count);
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectmatrixvariable-getmatrixarray
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetMatrixArray(ref float pData, uint Offset, uint Count) =>
        ((delegate* unmanaged<ID3D10EffectMatrixVariable*,float*,uint,uint, HRESULT>)(((void**)*((void**)VTablePtr))[28]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData), Offset, Count);
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectmatrixvariable-setmatrixtranspose
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT SetMatrixTranspose(ref float pData) =>
        ((delegate* unmanaged<ID3D10EffectMatrixVariable*,float*, HRESULT>)(((void**)*((void**)VTablePtr))[29]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData));
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectmatrixvariable-getmatrixtranspose
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetMatrixTranspose(ref float pData) =>
        ((delegate* unmanaged<ID3D10EffectMatrixVariable*,float*, HRESULT>)(((void**)*((void**)VTablePtr))[30]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData));
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT SetMatrixTransposeArray(ref float pData, uint Offset, uint Count) =>
        ((delegate* unmanaged<ID3D10EffectMatrixVariable*,float*,uint,uint, HRESULT>)(((void**)*((void**)VTablePtr))[31]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData), Offset, Count);
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetMatrixTransposeArray(ref float pData, uint Offset, uint Count) =>
        ((delegate* unmanaged<ID3D10EffectMatrixVariable*,float*,uint,uint, HRESULT>)(((void**)*((void**)VTablePtr))[32]))((ID3D10EffectMatrixVariable*)VTablePtr, (float*)Unsafe.AsPointer(ref pData), Offset, Count);
}
