...
public partial interface IDXCoreAdapterFactory
{
    ...
    HRESULT CreateAdapterList(uint numAttributes, [In][MarshalUsing(CountElementName = nameof(numAttributes))] Guid[] filterAttributes, in Guid riid, out nint /* void */ ppvAdapterList);
    
    // https://learn.microsoft.com/windows/win32/api/dxcore_interface/nf-dxcore_interface-idxcoreadapterfactory-getadapterbyluid
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetAdapterByLuid(in LUID adapterLUID, in Guid riid, out nint /* void */ ppvAdapter);
