...
public partial interface IMemAllocator
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetBuffer([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IMediaSample>))] out IMediaSample ppBuffer, nint /* optional long* */ pStartTime, nint /* optional long* */ pEndTime, uint dwFlags);
