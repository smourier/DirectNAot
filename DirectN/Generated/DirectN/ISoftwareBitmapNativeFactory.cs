...
public partial interface ISoftwareBitmapNativeFactory : IInspectable
{
    ...
    HRESULT CreateFromWICBitmap(IWICBitmap data, [MarshalAs(UnmanagedType.U4)] bool forceReadOnly, in Guid riid, out nint /* void */ ppv);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateFromMF2DBuffer2(IMF2DBuffer2 data, in Guid subtype, uint width, uint height, [MarshalAs(UnmanagedType.U4)] bool forceReadOnly, nint /* optional MFVideoArea* */ minDisplayAperture, in Guid riid, out nint /* void */ ppv);
}
