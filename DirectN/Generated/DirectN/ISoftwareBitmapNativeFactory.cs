...
public partial interface ISoftwareBitmapNativeFactory : IInspectable
{
    ...
    HRESULT CreateFromWICBitmap([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IWICBitmap>))] IWICBitmap data, BOOL forceReadOnly, in Guid riid, out nint /* void */ ppv);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateFromMF2DBuffer2([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IMF2DBuffer2>))] IMF2DBuffer2 data, in Guid subtype, uint width, uint height, BOOL forceReadOnly, nint /* optional MFVideoArea* */ minDisplayAperture, in Guid riid, out nint /* void */ ppv);
}
