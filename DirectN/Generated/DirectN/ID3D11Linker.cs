...
public partial interface ID3D11Linker
{
    ...
    HRESULT Link([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D11ModuleInstance>))] ID3D11ModuleInstance pEntry, PSTR pEntryName, PSTR pTargetName, uint uFlags, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3DBlob>))] out ID3DBlob ppShaderBlob, nint /* optional ID3DBlob* */ ppErrorBuffer);
    
    // https://learn.microsoft.com/windows/win32/api/d3d11shader/nf-d3d11shader-id3d11linker-uselibrary
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT UseLibrary([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D11ModuleInstance>))] ID3D11ModuleInstance pLibraryMI);
