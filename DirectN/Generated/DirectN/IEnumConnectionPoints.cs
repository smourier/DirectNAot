...
public partial interface IEnumConnectionPoints
{
    ...
    HRESULT Next(uint cConnections, [In][Out][MarshalUsing(CountElementName = nameof(cConnections))] nint[] ppCP, out uint pcFetched);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT Clone([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IEnumConnectionPoints>))] out IEnumConnectionPoints ppEnum);
}
