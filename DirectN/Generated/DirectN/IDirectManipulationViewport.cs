...
public partial interface IDirectManipulationViewport
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT AddContent([MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDirectManipulationContent>))] IDirectManipulationContent content);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT AddEventHandler(HWND window, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDirectManipulationViewportEventHandler>))] IDirectManipulationViewportEventHandler eventHandler, out uint cookie);
