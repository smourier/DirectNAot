...
public partial interface IDWriteTextRenderer : IDWritePixelSnapping
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT DrawInlineObject(nint /* optional void* */ clientDrawingContext, float originX, float originY, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDWriteInlineObject>))] IDWriteInlineObject inlineObject, BOOL isSideways, BOOL isRightToLeft, nint clientDrawingEffect);
}
