...
public partial interface IVMRMonitorConfig
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetAvailableMonitors([In][Out][MarshalUsing(CountElementName = nameof(dwMaxInfoArraySize))] VMRMONITORINFO[] pInfo, uint dwMaxInfoArraySize, out uint pdwNumDevices);
}
