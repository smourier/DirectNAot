...
public partial interface IMFMediaSharingEngineClassFactory
{
    ...
    HRESULT CreateInstance(uint dwFlags, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IMFAttributes>))] IMFAttributes pAttr, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IMFMediaSharingEngine>))] out IMFMediaSharingEngine ppEngine);
}
