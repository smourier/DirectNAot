...
public partial interface IDxcCompiler3
{
    ...
    HRESULT Compile(in DxcBuffer pSource, nint /* optional PWSTR* */ pArguments, uint argCount, IDxcIncludeHandler? pIncludeHandler, in Guid riid, out nint /* void */ ppResult);
