...
public partial interface IWMReaderAdvanced4 : IWMReaderAdvanced3
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetLanguage(uint dwOutputNum, ushort wLanguage, [MarshalUsing(CountElementName = nameof(pcchLanguageStringLength))] PWSTR pwszLanguageString, ref ushort pcchLanguageStringLength);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetURL([MarshalUsing(CountElementName = nameof(pcchURL))] PWSTR pwszURL, ref uint pcchURL);
}
