...
public partial interface IDWriteFontSet1 : IDWriteFontSet
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetFilteredFonts([In][MarshalUsing(CountElementName = nameof(fontAxisRangeCount))] DWRITE_FONT_AXIS_RANGE[] fontAxisRanges, uint fontAxisRangeCount, [MarshalAs(UnmanagedType.U4)] bool selectAnyRange, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDWriteFontSet1>))] out IDWriteFontSet1 filteredFontSet);
    
    // https://learn.microsoft.com/windows/win32/api/dwrite_3/nf-dwrite_3-idwritefontset1-getfilteredfonts(uint32const_uint32_idwritefontset1)
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetFilteredFonts(nint /* optional DWRITE_FONT_PROPERTY* */ properties, uint propertyCount, [MarshalAs(UnmanagedType.U4)] bool selectAnyProperty, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IDWriteFontSet1>))] out IDWriteFontSet1 filteredFontSet);
