...
public partial interface IWMOutputMediaProps : IWMMediaProps
{
    ...
    HRESULT GetStreamGroupName([MarshalUsing(CountElementName = nameof(pcchName))] PWSTR pwszName, ref ushort pcchName);
    
    // https://learn.microsoft.com/windows/win32/api/wmsdkidl/nf-wmsdkidl-iwmoutputmediaprops-getconnectionname
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetConnectionName([MarshalUsing(CountElementName = nameof(pcchName))] PWSTR pwszName, ref ushort pcchName);
}
