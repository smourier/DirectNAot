...
public partial interface ID3D12Device5 : ID3D12Device4
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateMetaCommand(in Guid CommandId, uint NodeMask, nint /* optional void* */ pCreationParametersData, nuint CreationParametersDataSizeInBytes, in Guid riid, out nint /* void */ ppMetaCommand);
    
    // https://learn.microsoft.com/windows/win32/api/d3d12/nf-d3d12-id3d12device5-createstateobject
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateStateObject(in D3D12_STATE_OBJECT_DESC pDesc, in Guid riid, out nint /* void */ ppStateObject);
