...
public partial interface IMFDeviceTransform
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetInputStreamPreferredState(uint dwStreamID, out DeviceStreamState value, out IMFMediaType ppMediaType);
