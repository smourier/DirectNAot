...
public partial interface IMFHttpDownloadSession
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateRequest(PWSTR szObjectName, [MarshalAs(UnmanagedType.U4)] bool fBypassProxyCache, [MarshalAs(UnmanagedType.U4)] bool fSecure, PWSTR szVerb, PWSTR szReferrer, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<IMFHttpDownloadRequest>))] out IMFHttpDownloadRequest ppRequest);
