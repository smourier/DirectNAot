...
public partial struct ID3D10EffectRasterizerVariable
{
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetRasterizerState(uint Index, ref nint ppRasterizerState)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectRasterizerVariable*,uint,nint*, HRESULT>)(((void**)VTablePtr)[25]))((ID3D10EffectRasterizerVariable*)VTablePtr, Index, (nint*)Unsafe.AsPointer(ref ppRasterizerState));
    }
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectrasterizervariable-getbackingstore
    [return: MarshalAs(UnmanagedType.Error)]
    public unsafe HRESULT GetBackingStore(uint Index, ref D3D10_RASTERIZER_DESC pRasterizerDesc)
    {
        return ((delegate* unmanaged[MemberFunction]<ID3D10EffectRasterizerVariable*,uint,D3D10_RASTERIZER_DESC*, HRESULT>)(((void**)VTablePtr)[26]))((ID3D10EffectRasterizerVariable*)VTablePtr, Index, (D3D10_RASTERIZER_DESC*)Unsafe.AsPointer(ref pRasterizerDesc));
    }
}
