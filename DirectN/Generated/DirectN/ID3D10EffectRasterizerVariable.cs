...
public partial struct ID3D10EffectRasterizerVariable
{
    public static readonly ID3D10EffectRasterizerVariable Null = new();
    ...
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetRasterizerState(uint Index, ref nint ppRasterizerState) =>
        ((delegate* unmanaged<ID3D10EffectRasterizerVariable*,uint,nint*, HRESULT>)(((void**)*((void**)VTablePtr))[25]))((ID3D10EffectRasterizerVariable*)VTablePtr, Index, (nint*)Unsafe.AsPointer(ref ppRasterizerState));
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectrasterizervariable-getbackingstore
    [return: MarshalAs(UnmanagedType.Error)]
    public readonly unsafe HRESULT GetBackingStore(uint Index, ref D3D10_RASTERIZER_DESC pRasterizerDesc) =>
        ((delegate* unmanaged<ID3D10EffectRasterizerVariable*,uint,D3D10_RASTERIZER_DESC*, HRESULT>)(((void**)*((void**)VTablePtr))[26]))((ID3D10EffectRasterizerVariable*)VTablePtr, Index, (D3D10_RASTERIZER_DESC*)Unsafe.AsPointer(ref pRasterizerDesc));
}
