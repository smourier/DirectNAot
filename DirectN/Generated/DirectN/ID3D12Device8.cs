...
public partial interface ID3D12Device8 : ID3D12Device7
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreatePlacedResource1([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D12Heap>))] ID3D12Heap pHeap, ulong HeapOffset, in D3D12_RESOURCE_DESC1 pDesc, D3D12_RESOURCE_STATES InitialState, nint /* optional D3D12_CLEAR_VALUE* */ pOptimizedClearValue, in Guid riid, out nint /* void */ ppvResource);
    
    // https://learn.microsoft.com/windows/win32/api/d3d12/nf-d3d12-id3d12device8-createsamplerfeedbackunorderedaccessview
    [PreserveSig]
    void CreateSamplerFeedbackUnorderedAccessView([MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D12Resource?>))] ID3D12Resource? pTargetedResource, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<ID3D12Resource?>))] ID3D12Resource? pFeedbackResource, D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);
