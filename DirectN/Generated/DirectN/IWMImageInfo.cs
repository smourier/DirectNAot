...
public partial interface IWMImageInfo
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetImage(uint wIndex, ref ushort pcchMIMEType, [MarshalUsing(CountElementName = nameof(pcchMIMEType))] PWSTR pwszMIMEType, ref ushort pcchDescription, [MarshalUsing(CountElementName = nameof(pcchDescription))] PWSTR pwszDescription, out ushort pImageType, ref uint pcbImageData, nint /* byte array */ pbImageData);
}
