...
public partial struct D3D10_TEX2DMS_SRV : IEquatable<D3D10_TEX2DMS_SRV>, IValueGet<uint>
{
    ...
    public D3D10_TEX2DMS_SRV(uint value) => this.UnusedField_NothingToDefine = value;
    public override readonly string ToString() => $"0x{UnusedField_NothingToDefine:x}";
    
    public override readonly bool Equals(object? obj) => obj is D3D10_TEX2DMS_SRV value && Equals(value);
    public readonly bool Equals(D3D10_TEX2DMS_SRV other) => other.UnusedField_NothingToDefine == UnusedField_NothingToDefine;
