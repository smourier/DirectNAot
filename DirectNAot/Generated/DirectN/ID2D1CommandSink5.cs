...
public partial interface ID2D1CommandSink5 : ID2D1CommandSink4
{
    ...
    HRESULT BlendImage(ID2D1Image image, D2D1_BLEND_MODE blendMode, nint/* nint */ targetOffset, nint/* nint */ imageRectangle, D2D1_INTERPOLATION_MODE interpolationMode);
}
