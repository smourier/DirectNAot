...
public partial interface IXpsOMFontResourceCollection
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetByPartName(IOpcPartUri partName, out IXpsOMFontResource part);
}
