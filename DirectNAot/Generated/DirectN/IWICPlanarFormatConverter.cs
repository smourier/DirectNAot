...
public partial interface IWICPlanarFormatConverter : IWICBitmapSource
{
    ...
    HRESULT Initialize(in IWICBitmapSource ppPlanes, uint cPlanes, in Guid dstFormat, WICBitmapDitherType dither, IWICPalette pIPalette, double alphaThresholdPercent, WICBitmapPaletteType paletteTranslate);
    
    // https://learn.microsoft.com/windows/win32/api/wincodec/nf-wincodec-iwicplanarformatconverter-canconvert
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CanConvert(in Guid pSrcPixelFormats, uint cSrcPlanes, in Guid dstPixelFormat, [MarshalAs(UnmanagedType.U4)] out bool pfCanConvert);
}
