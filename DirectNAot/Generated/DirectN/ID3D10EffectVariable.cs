...
public partial interface ID3D10EffectVariable
{
    ...
    public HRESULT GetDesc(out D3D10_EFFECT_VARIABLE_DESC pDesc);
    ...
    [PreserveSig]
    public ID3D10EffectVariable GetMemberByName(PSTR Name);
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectvariable-getmemberbysemantic
    [PreserveSig]
    public ID3D10EffectVariable GetMemberBySemantic(PSTR Semantic);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT SetRawValue(nint pData, uint Offset, uint ByteCount);
    
    // https://learn.microsoft.com/windows/win32/api/d3d10effect/nf-d3d10effect-id3d10effectvariable-getrawvalue
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetRawValue(nint pData, uint Offset, uint ByteCount);
}
