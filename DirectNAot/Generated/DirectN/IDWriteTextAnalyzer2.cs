...
public partial interface IDWriteTextAnalyzer2 : IDWriteTextAnalyzer1
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetTypographicFeatures(IDWriteFontFace fontFace, DWRITE_SCRIPT_ANALYSIS scriptAnalysis, PWSTR localeName, uint maxTagCount, out uint actualTagCount, [MarshalUsing(CountElementName = nameof(maxTagCount))] ref DWRITE_FONT_FEATURE_TAG[] tags);
