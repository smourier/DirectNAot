...
public partial interface IDWriteFactory5 : IDWriteFactory4
{
    ...
    HRESULT CreateFontSetBuilder(out IDWriteFontSetBuilder1 fontSetBuilder);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT UnpackFontFile(DWRITE_CONTAINER_TYPE containerType, nint fileData, uint fileDataSize, out IDWriteFontFileStream unpackedFontStream);
}
