...
public partial interface IMFByteStreamHandler
{
    ...
    HRESULT BeginCreateObject(IMFByteStream pByteStream, PWSTR pwszURL, uint dwFlags, IPropertyStore pProps, nint/* nint */ ppIUnknownCancelCookie, IMFAsyncCallback pCallback, nint punkState);
