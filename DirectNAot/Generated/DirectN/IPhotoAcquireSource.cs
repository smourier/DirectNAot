...
public partial interface IPhotoAcquireSource
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetDeviceIcons(uint nSize, nint/* nint */ phLargeIcon, nint/* nint */ phSmallIcon);
    
    // https://learn.microsoft.com/windows/win32/api/photoacquire/nf-photoacquire-iphotoacquiresource-initializeitemlist
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT InitializeItemList([MarshalAs(UnmanagedType.U4)] bool fForceEnumeration, IPhotoAcquireProgressCB pPhotoAcquireProgressCB, nint/* nint */ pnItemCount);
