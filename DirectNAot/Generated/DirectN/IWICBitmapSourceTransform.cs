...
public partial interface IWICBitmapSourceTransform
{
    ...
    public HRESULT CopyPixels(in WICRect prc, uint uiWidth, uint uiHeight, in Guid pguidDstFormat, WICBitmapTransformOptions dstTransform, uint nStride, uint cbBufferSize, nint /* byte array */ pbBuffer);
    
    // https://learn.microsoft.com/windows/win32/api/wincodec/nf-wincodec-iwicbitmapsourcetransform-getclosestsize
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetClosestSize(ref uint puiWidth, ref uint puiHeight);
    
    // https://learn.microsoft.com/windows/win32/api/wincodec/nf-wincodec-iwicbitmapsourcetransform-getclosestpixelformat
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetClosestPixelFormat(ref Guid pguidDstFormat);
    
    // https://learn.microsoft.com/windows/win32/api/wincodec/nf-wincodec-iwicbitmapsourcetransform-doessupporttransform
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT DoesSupportTransform(WICBitmapTransformOptions dstTransform, [MarshalAs(UnmanagedType.U4)] out bool pfIsSupported);
}
