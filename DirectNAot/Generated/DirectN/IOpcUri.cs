...
public partial interface IOpcUri : IUri
{
    ...
    public HRESULT GetRelationshipsPartUri(out IOpcPartUri relationshipPartUri);
    
    // https://learn.microsoft.com/windows/win32/api/msopc/nf-msopc-iopcuri-getrelativeuri
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetRelativeUri(IOpcPartUri targetPartUri, out IUri relativeUri);
    
    // https://learn.microsoft.com/windows/win32/api/msopc/nf-msopc-iopcuri-combineparturi
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT CombinePartUri(IUri relativeUri, out IOpcPartUri combinedUri);
}
