...
public partial interface ID3D12VideoProcessor : ID3D12Pageable
{
    ...
    HRESULT GetInputStreamDescs(uint NumInputStreamDescs, [MarshalUsing(CountElementName = nameof(NumInputStreamDescs))] ref D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC[] pInputStreamDescs);
