...
public partial interface IDxcUtils
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT LoadFile(PWSTR pFileName, nint/* nint */ pCodePage, out IDxcBlobEncoding pBlobEncoding);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT BuildArguments(PWSTR pSourceName, PWSTR pEntryPoint, PWSTR pTargetProfile, nint/* nint */ pArguments, uint argCount, in DxcDefine pDefines, uint defineCount, out IDxcCompilerArgs ppArgs);
