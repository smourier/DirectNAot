...
public partial interface IDirectDrawSurface3
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT Blt(ref FoundationRECT param0, IDirectDrawSurface3 param1, ref FoundationRECT param2, uint param3, ref DDBLTFX param4);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT BltFast(uint param0, uint param1, IDirectDrawSurface3 param2, ref FoundationRECT param3, uint param4);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetAttachedSurface(ref DDSCAPS param0, out IDirectDrawSurface3 param1);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT Lock(ref FoundationRECT param0, ref DDSURFACEDESC param1, uint param2, HANDLE param3);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT UpdateOverlay(ref FoundationRECT param0, IDirectDrawSurface3 param1, ref FoundationRECT param2, uint param3, ref DDOVERLAYFX param4);
