...
public partial interface IDXGIOutput5 : IDXGIOutput4
{
    ...
    HRESULT DuplicateOutput1(nint pDevice, uint Flags, uint SupportedFormatsCount, [In][MarshalUsing(CountElementName = nameof(SupportedFormatsCount))] DXGI_FORMAT[] pSupportedFormats, out IDXGIOutputDuplication ppOutputDuplication);
}
