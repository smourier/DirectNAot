...
public partial interface IDXGIOutput5 : IDXGIOutput4
{
    ...
    HRESULT DuplicateOutput1(nint pDevice, uint Flags, uint SupportedFormatsCount, [MarshalUsing(CountElementName = nameof(SupportedFormatsCount))] in DXGI_FORMAT[] pSupportedFormats, out IDXGIOutputDuplication ppOutputDuplication);
}
