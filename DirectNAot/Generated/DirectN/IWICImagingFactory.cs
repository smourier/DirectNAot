...
public partial interface IWICImagingFactory
{
    ...
    HRESULT CreateDecoderFromFilename(PWSTR wzFilename, nint/* nint */ pguidVendor, GENERIC_ACCESS_RIGHTS dwDesiredAccess, WICDecodeOptions metadataOptions, out IWICBitmapDecoder ppIDecoder);
