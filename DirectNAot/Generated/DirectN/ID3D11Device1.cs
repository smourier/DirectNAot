...
public partial interface ID3D11Device1 : ID3D11Device
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateDeviceContextState(uint Flags, in D3D_FEATURE_LEVEL pFeatureLevels, uint FeatureLevels, uint SDKVersion, in Guid EmulatedInterface, nint /* optional D3D_FEATURE_LEVEL */ pChosenFeatureLevel, nint /* optional ID3DDeviceContextState */ ppContextState);
