...
public partial interface ID3D11Device1 : ID3D11Device
{
    ...
    HRESULT CreateDeferredContext1(uint ContextFlags, nint/* nint */ ppDeferredContext);
    
    // https://learn.microsoft.com/windows/win32/api/d3d11_1/nf-d3d11_1-id3d11device1-createblendstate1
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateBlendState1(in D3D11_BLEND_DESC1 pBlendStateDesc, nint/* nint */ ppBlendState);
    
    // https://learn.microsoft.com/windows/win32/api/d3d11_1/nf-d3d11_1-id3d11device1-createrasterizerstate1
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateRasterizerState1(in D3D11_RASTERIZER_DESC1 pRasterizerDesc, nint/* nint */ ppRasterizerState);
    
    // https://learn.microsoft.com/windows/win32/api/d3d11_1/nf-d3d11_1-id3d11device1-createdevicecontextstate
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateDeviceContextState(uint Flags, in D3D_FEATURE_LEVEL pFeatureLevels, uint FeatureLevels, uint SDKVersion, in Guid EmulatedInterface, nint/* nint */ pChosenFeatureLevel, nint/* nint */ ppContextState);
