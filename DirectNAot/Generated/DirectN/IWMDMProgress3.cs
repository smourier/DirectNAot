...
public partial interface IWMDMProgress3 : IWMDMProgress2
{
    ...
    HRESULT Begin3(Guid EventId, uint dwEstimatedTicks, nint/* nint */ pContext);
    
    // https://learn.microsoft.com/windows/win32/api/mswmdm/nf-mswmdm-iwmdmprogress3-progress3
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT Progress3(Guid EventId, uint dwTranspiredTicks, nint/* nint */ pContext);
    
    // https://learn.microsoft.com/windows/win32/api/mswmdm/nf-mswmdm-iwmdmprogress3-end3
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT End3(Guid EventId, HRESULT hrCompletionCode, nint/* nint */ pContext);
}
