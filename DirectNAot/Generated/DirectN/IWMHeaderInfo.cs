...
public partial interface IWMHeaderInfo
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetAttributeByIndex(ushort wIndex, ref ushort pwStreamNum, out PWSTR pwszName, ref ushort pcchNameLen, out WMT_ATTR_DATATYPE pType, nint /* byte array */ pValue, ref ushort pcbLength);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetMarker(ushort wIndex, out PWSTR pwszMarkerName, ref ushort pcchMarkerNameLen, out ulong pcnsMarkerTime);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetScript(ushort wIndex, out PWSTR pwszType, ref ushort pcchTypeLen, out PWSTR pwszCommand, ref ushort pcchCommandLen, out ulong pcnsScriptTime);
