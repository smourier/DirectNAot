...
public partial interface ID3D12Resource : ID3D12Pageable
{
    ...
    HRESULT Map(uint Subresource, nint/* nint */ pReadRange, nint/* nint */ ppData);
    
    // https://learn.microsoft.com/windows/win32/api/d3d12/nf-d3d12-id3d12resource-unmap
    [PreserveSig]
    void Unmap(uint Subresource, nint/* nint */ pWrittenRange);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT WriteToSubresource(uint DstSubresource, nint/* nint */ pDstBox, nint pSrcData, uint SrcRowPitch, uint SrcDepthPitch);
    
    // https://learn.microsoft.com/windows/win32/api/d3d12/nf-d3d12-id3d12resource-readfromsubresource
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT ReadFromSubresource(nint pDstData, uint DstRowPitch, uint DstDepthPitch, uint SrcSubresource, nint/* nint */ pSrcBox);
    
    // https://learn.microsoft.com/windows/win32/api/d3d12/nf-d3d12-id3d12resource-getheapproperties
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetHeapProperties(nint/* nint */ pHeapProperties, nint/* nint */ pHeapFlags);
}
