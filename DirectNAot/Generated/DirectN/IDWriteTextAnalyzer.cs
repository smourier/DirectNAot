...
public partial interface IDWriteTextAnalyzer
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetGlyphs([In][Out][MarshalUsing(CountElementName = nameof(textLength))] PWSTR[] textString, uint textLength, IDWriteFontFace fontFace, [MarshalAs(UnmanagedType.U4)] bool isSideways, [MarshalAs(UnmanagedType.U4)] bool isRightToLeft, in DWRITE_SCRIPT_ANALYSIS scriptAnalysis, PWSTR localeName, IDWriteNumberSubstitution? numberSubstitution, nint /* optional DWRITE_TYPOGRAPHIC_FEATURES** */ features, nint /* optional uint* */ featureRangeLengths, uint featureRanges, uint maxGlyphCount, [MarshalUsing(CountElementName = nameof(textLength))] out ushort[] clusterMap, [MarshalUsing(CountElementName = nameof(textLength))] out DWRITE_SHAPING_TEXT_PROPERTIES[] textProps, [MarshalUsing(CountElementName = nameof(maxGlyphCount))] out ushort[] glyphIndices, [MarshalUsing(CountElementName = nameof(maxGlyphCount))] out DWRITE_SHAPING_GLYPH_PROPERTIES[] glyphProps, out uint actualGlyphCount);
    
    // https://learn.microsoft.com/windows/win32/api/dwrite/nf-dwrite-idwritetextanalyzer-getglyphplacements
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetGlyphPlacements([In][Out][MarshalUsing(CountElementName = nameof(textLength))] PWSTR[] textString, [MarshalUsing(CountElementName = nameof(textLength))] in ushort[] clusterMap, [MarshalUsing(CountElementName = nameof(textLength))] ref DWRITE_SHAPING_TEXT_PROPERTIES[] textProps, uint textLength, [MarshalUsing(CountElementName = nameof(glyphCount))] in ushort[] glyphIndices, [MarshalUsing(CountElementName = nameof(glyphCount))] in DWRITE_SHAPING_GLYPH_PROPERTIES[] glyphProps, uint glyphCount, IDWriteFontFace fontFace, float fontEmSize, [MarshalAs(UnmanagedType.U4)] bool isSideways, [MarshalAs(UnmanagedType.U4)] bool isRightToLeft, in DWRITE_SCRIPT_ANALYSIS scriptAnalysis, PWSTR localeName, nint /* optional DWRITE_TYPOGRAPHIC_FEATURES** */ features, nint /* optional uint* */ featureRangeLengths, uint featureRanges, [MarshalUsing(CountElementName = nameof(glyphCount))] out float[] glyphAdvances, [MarshalUsing(CountElementName = nameof(glyphCount))] out DWRITE_GLYPH_OFFSET[] glyphOffsets);
    
    // https://learn.microsoft.com/windows/win32/DirectWrite/idwritetextanalyzer-getgdicompatibleglyphplacements
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetGdiCompatibleGlyphPlacements([In][Out][MarshalUsing(CountElementName = nameof(textLength))] PWSTR[] textString, [MarshalUsing(CountElementName = nameof(textLength))] in ushort[] clusterMap, [MarshalUsing(CountElementName = nameof(textLength))] in DWRITE_SHAPING_TEXT_PROPERTIES[] textProps, uint textLength, [MarshalUsing(CountElementName = nameof(glyphCount))] in ushort[] glyphIndices, [MarshalUsing(CountElementName = nameof(glyphCount))] in DWRITE_SHAPING_GLYPH_PROPERTIES[] glyphProps, uint glyphCount, IDWriteFontFace fontFace, float fontEmSize, float pixelsPerDip, nint /* optional DWRITE_MATRIX* */ transform, [MarshalAs(UnmanagedType.U4)] bool useGdiNatural, [MarshalAs(UnmanagedType.U4)] bool isSideways, [MarshalAs(UnmanagedType.U4)] bool isRightToLeft, in DWRITE_SCRIPT_ANALYSIS scriptAnalysis, PWSTR localeName, nint /* optional DWRITE_TYPOGRAPHIC_FEATURES** */ features, nint /* optional uint* */ featureRangeLengths, uint featureRanges, [MarshalUsing(CountElementName = nameof(glyphCount))] out float[] glyphAdvances, [MarshalUsing(CountElementName = nameof(glyphCount))] out DWRITE_GLYPH_OFFSET[] glyphOffsets);
}
