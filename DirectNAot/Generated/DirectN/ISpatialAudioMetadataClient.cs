...
public partial interface ISpatialAudioMetadataClient
{
    ...
    HRESULT ActivateSpatialAudioMetadataItems(ushort maxItemCount, ushort frameCount, nint/* nint */ metadataItemsBuffer, out ISpatialAudioMetadataItems metadataItems);
