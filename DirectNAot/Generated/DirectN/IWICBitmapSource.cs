...
public partial interface IWICBitmapSource
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetResolution(out double pDpiX, out double pDpiY);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT CopyPixels(in WICRect prc, uint cbStride, uint cbBufferSize, nint /* byte array */ pbBuffer);
}
