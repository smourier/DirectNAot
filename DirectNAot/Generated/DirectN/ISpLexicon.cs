...
public partial interface ISpLexicon
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT AddPronunciation(PWSTR pszWord, ushort LangID, SPPARTOFSPEECH ePartOfSpeech, nint/* nint */ pszPronunciation);
    
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT RemovePronunciation(PWSTR pszWord, ushort LangID, SPPARTOFSPEECH ePartOfSpeech, nint/* nint */ pszPronunciation);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetWords(uint dwFlags, ref uint pdwGeneration, nint/* nint */ pdwCookie, ref SPWORDLIST pWordList);
}
