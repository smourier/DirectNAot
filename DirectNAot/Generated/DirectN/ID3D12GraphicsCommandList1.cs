...
public partial interface ID3D12GraphicsCommandList1 : ID3D12GraphicsCommandList
{
    ...
    [PreserveSig]
    void ResolveSubresourceRegion(ID3D12Resource pDstResource, uint DstSubresource, uint DstX, uint DstY, ID3D12Resource pSrcResource, uint SrcSubresource, nint/* nint */ pSrcRect, DXGI_FORMAT Format, D3D12_RESOLVE_MODE ResolveMode);
