...
public partial interface IOpcPartUri : IOpcUri
{
    ...
    public HRESULT ComparePartUri(IOpcPartUri partUri, out int comparisonResult);
    
    // https://learn.microsoft.com/windows/win32/api/msopc/nf-msopc-iopcparturi-getsourceuri
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetSourceUri(out IOpcUri sourceUri);
    
    // https://learn.microsoft.com/windows/win32/api/msopc/nf-msopc-iopcparturi-isrelationshipsparturi
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT IsRelationshipsPartUri([MarshalAs(UnmanagedType.U4)] out bool isRelationshipUri);
}
