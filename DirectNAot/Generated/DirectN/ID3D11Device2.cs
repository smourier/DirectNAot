...
public partial interface ID3D11Device2 : ID3D11Device1
{
    ...
    HRESULT CreateDeferredContext2(uint ContextFlags, nint/* nint */ ppDeferredContext);
    
    // https://learn.microsoft.com/windows/win32/api/d3d11_2/nf-d3d11_2-id3d11device2-getresourcetiling
    [PreserveSig]
    void GetResourceTiling(ID3D11Resource pTiledResource, nint/* nint */ pNumTilesForEntireResource, nint/* nint */ pPackedMipDesc, nint/* nint */ pStandardTileShapeForNonPackedMips, nint/* nint */ pNumSubresourceTilings, uint FirstSubresourceTilingToGet, out D3D11_SUBRESOURCE_TILING pSubresourceTilingsForNonPackedMips);
