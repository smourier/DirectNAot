...
public partial interface IMFReadWriteClassFactory
{
    ...
    HRESULT CreateInstanceFromURL(in Guid clsid, PWSTR pwszURL, IMFAttributes pAttributes, in Guid riid, out nint ppvObject);
    
    // https://learn.microsoft.com/windows/win32/api/mfreadwrite/nf-mfreadwrite-imfreadwriteclassfactory-createinstancefromobject
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateInstanceFromObject(in Guid clsid, nint punkObject, IMFAttributes pAttributes, in Guid riid, out nint ppvObject);
}
