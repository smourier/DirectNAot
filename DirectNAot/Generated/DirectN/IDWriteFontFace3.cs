...
public partial interface IDWriteFontFace3 : IDWriteFontFace2
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT AreCharactersLocal(PWSTR characters, uint characterCount, [MarshalAs(UnmanagedType.U4)] bool enqueueIfNotLocal, [MarshalAs(UnmanagedType.U4)] out bool isLocal);
    
    // https://learn.microsoft.com/windows/win32/api/dwrite_3/nf-dwrite_3-idwritefontface3-areglyphslocal
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT AreGlyphsLocal(in ushort glyphIndices, uint glyphCount, [MarshalAs(UnmanagedType.U4)] bool enqueueIfNotLocal, [MarshalAs(UnmanagedType.U4)] out bool isLocal);
}
