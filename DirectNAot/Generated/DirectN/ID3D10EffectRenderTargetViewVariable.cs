...
public partial interface ID3D10EffectRenderTargetViewVariable : ID3D10EffectVariable
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT SetRenderTargetArray(in ID3D10RenderTargetView ppResources, uint Offset, uint Count);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetRenderTargetArray(out ID3D10RenderTargetView ppResources, uint Offset, uint Count);
}
