...
public partial interface ID2D1DeviceContext4 : ID2D1DeviceContext3
{
    ...
    [PreserveSig]
    void DrawText([In][Out][MarshalUsing(CountElementName = nameof(stringLength))] PWSTR[] @string, uint stringLength, IDWriteTextFormat textFormat, in D2D_RECT_F layoutRect, ID2D1Brush? defaultFillBrush, ID2D1SvgGlyphStyle? svgGlyphStyle, uint colorPaletteIndex, D2D1_DRAW_TEXT_OPTIONS options, DWRITE_MEASURING_MODE measuringMode);
