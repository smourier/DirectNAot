...
public partial interface IXpsOMPartResources
{
    ...
    public HRESULT GetFontResources(out IXpsOMFontResourceCollection fontResources);
    
    // https://learn.microsoft.com/windows/win32/api/xpsobjectmodel/nf-xpsobjectmodel-ixpsompartresources-getimageresources
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetImageResources(out IXpsOMImageResourceCollection imageResources);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetColorProfileResources(out IXpsOMColorProfileResourceCollection colorProfileResources);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetRemoteDictionaryResources(out IXpsOMRemoteDictionaryResourceCollection dictionaryResources);
}
