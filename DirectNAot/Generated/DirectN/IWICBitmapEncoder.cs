...
public partial interface IWICBitmapEncoder
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetEncoderInfo(out IWICBitmapEncoderInfo ppIEncoderInfo);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT CreateNewFrame(out IWICBitmapFrameEncode ppIFrameEncode, ref IPropertyBag2 ppIEncoderOptions);
