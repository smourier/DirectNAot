...
public partial interface ID3D12VideoDevice
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateVideoProcessor(uint NodeMask, in D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC pOutputStreamDesc, uint NumInputStreamDescs, [In][MarshalUsing(CountElementName = nameof(NumInputStreamDescs))] D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC[] pInputStreamDescs, in Guid riid, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<object>))] out object /* void */ ppVideoProcessor);
}
