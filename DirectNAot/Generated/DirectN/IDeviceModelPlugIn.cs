...
public partial interface IDeviceModelPlugIn
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT DeviceToColorimetricColors(uint cColors, uint cChannels, in float pDeviceValues, out XYZColorF pXYZColors);
    
    // https://learn.microsoft.com/windows/win32/api/wcsplugin/nf-wcsplugin-idevicemodelplugin-colorimetrictodevicecolors
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT ColorimetricToDeviceColors(uint cColors, uint cChannels, in XYZColorF pXYZColors, out float pDeviceValues);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT ColorimetricToDeviceColorsWithBlack(uint cColors, uint cChannels, in XYZColorF pXYZColors, in BlackInformation pBlackInformation, out float pDeviceValues);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetGamutBoundaryMesh(uint cChannels, uint cVertices, uint cTriangles, out float pVertices, out GamutShellTriangle pTriangles);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetNeutralAxis(uint cColors, out XYZColorF pXYZColors);
}
