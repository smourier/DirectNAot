...
public partial interface IDXGIInfoQueue
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetMessage(Guid Producer, ulong MessageIndex, nint/* nint */ pMessage, ref nuint pMessageByteLength);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetStorageFilter(Guid Producer, nint/* nint */ pFilter, ref nuint pFilterByteLength);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetRetrievalFilter(Guid Producer, nint/* nint */ pFilter, ref nuint pFilterByteLength);
