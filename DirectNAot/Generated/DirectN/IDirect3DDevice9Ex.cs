...
public partial interface IDirect3DDevice9Ex : IDirect3DDevice9
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT PresentEx(FoundationRECT pSourceRect, FoundationRECT pDestRect, HWND hDestWindowOverride, in RGNDATA pDirtyRegion, uint dwFlags);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT CheckResourceResidency(out IDirect3DResource9 pResourceArray, uint NumResources);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT CreateRenderTargetEx(uint Width, uint Height, D3DFORMAT Format, D3DMULTISAMPLE_TYPE MultiSample, uint MultisampleQuality, [MarshalAs(UnmanagedType.U4)] bool Lockable, out IDirect3DSurface9 ppSurface, ref HANDLE pSharedHandle, uint Usage);
    
    // https://learn.microsoft.com/windows/win32/api/d3d9/nf-d3d9-idirect3ddevice9ex-createoffscreenplainsurfaceex
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT CreateOffscreenPlainSurfaceEx(uint Width, uint Height, D3DFORMAT Format, D3DPOOL Pool, out IDirect3DSurface9 ppSurface, ref HANDLE pSharedHandle, uint Usage);
    
    // https://learn.microsoft.com/windows/win32/api/d3d9/nf-d3d9-idirect3ddevice9ex-createdepthstencilsurfaceex
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT CreateDepthStencilSurfaceEx(uint Width, uint Height, D3DFORMAT Format, D3DMULTISAMPLE_TYPE MultiSample, uint MultisampleQuality, [MarshalAs(UnmanagedType.U4)] bool Discard, out IDirect3DSurface9 ppSurface, ref HANDLE pSharedHandle, uint Usage);
    
    // https://learn.microsoft.com/windows/win32/api/d3d9/nf-d3d9-idirect3ddevice9ex-resetex
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT ResetEx(ref D3DPRESENT_PARAMETERS pPresentationParameters, ref D3DDISPLAYMODEEX pFullscreenDisplayMode);
