...
public partial interface ID2D1DrawInfo : ID2D1RenderInfo
{
    ...
    public HRESULT SetPixelShaderConstantBuffer(nint /* byte array */ buffer, uint bufferCount);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT SetVertexShaderConstantBuffer(nint /* byte array */ buffer, uint bufferCount);
    
    // https://learn.microsoft.com/windows/win32/api/d2d1effectauthor/nf-d2d1effectauthor-id2d1drawinfo-setpixelshader
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT SetPixelShader(in Guid shaderId, D2D1_PIXEL_OPTIONS pixelOptions);
