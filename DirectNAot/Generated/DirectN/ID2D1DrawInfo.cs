...
public partial interface ID2D1DrawInfo : ID2D1RenderInfo
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT SetVertexProcessing(ID2D1VertexBuffer vertexBuffer, D2D1_VERTEX_OPTIONS vertexOptions, nint/* nint */ blendDescription, nint/* nint */ vertexRange, nint/* nint */ vertexShader);
}
