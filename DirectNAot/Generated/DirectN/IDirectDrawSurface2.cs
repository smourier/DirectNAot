...
public partial interface IDirectDrawSurface2
{
    ...
    public HRESULT AddAttachedSurface(IDirectDrawSurface2 param0);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT Blt(ref FoundationRECT param0, IDirectDrawSurface2 param1, ref FoundationRECT param2, uint param3, ref DDBLTFX param4);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT BltFast(uint param0, uint param1, IDirectDrawSurface2 param2, ref FoundationRECT param3, uint param4);
    
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT DeleteAttachedSurface(uint param0, IDirectDrawSurface2 param1);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT Flip(IDirectDrawSurface2 param0, uint param1);
    
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetAttachedSurface(ref DDSCAPS param0, out IDirectDrawSurface2 param1);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT UpdateOverlay(ref FoundationRECT param0, IDirectDrawSurface2 param1, ref FoundationRECT param2, uint param3, ref DDOVERLAYFX param4);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT UpdateOverlayZOrder(uint param0, IDirectDrawSurface2 param1);
