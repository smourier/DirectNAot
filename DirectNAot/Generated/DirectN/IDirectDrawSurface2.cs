...
public partial interface IDirectDrawSurface2
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT Blt(ref FoundationRECT param0, IDirectDrawSurface2 param1, ref FoundationRECT param2, uint param3, ref DDBLTFX param4);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT BltFast(uint param0, uint param1, IDirectDrawSurface2 param2, ref FoundationRECT param3, uint param4);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetAttachedSurface(ref DDSCAPS param0, out IDirectDrawSurface2 param1);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT UpdateOverlay(ref FoundationRECT param0, IDirectDrawSurface2 param1, ref FoundationRECT param2, uint param3, ref DDOVERLAYFX param4);
