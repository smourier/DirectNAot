...
public partial interface ID2D1SvgGlyphStyle : ID2D1Resource
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT SetStroke(ID2D1Brush brush, float strokeWidth, nint/* nint */ dashes, uint dashesCount, float dashOffset);
    ...
    [PreserveSig]
    void GetStroke(nint/* nint */ brush, nint/* nint */ strokeWidth, nint/* nint */ dashes, uint dashesCount, nint/* nint */ dashOffset);
}
