...
public partial interface IFilterMapper2
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT RegisterFilter(in Guid clsidFilter, PWSTR Name, nint/* nint */ ppMoniker, in Guid pclsidCategory, PWSTR szInstance, in REGFILTER2 prf2);
    
    // https://learn.microsoft.com/windows/win32/api/strmif/nf-strmif-ifiltermapper2-enummatchingfilters
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT EnumMatchingFilters(out IEnumMoniker ppEnum, uint dwFlags, [MarshalAs(UnmanagedType.U4)] bool bExactMatch, uint dwMerit, [MarshalAs(UnmanagedType.U4)] bool bInputNeeded, uint cInputTypes, nint/* nint */ pInputTypes, nint/* nint */ pMedIn, nint/* nint */ pPinCategoryIn, [MarshalAs(UnmanagedType.U4)] bool bRender, [MarshalAs(UnmanagedType.U4)] bool bOutputNeeded, uint cOutputTypes, nint/* nint */ pOutputTypes, nint/* nint */ pMedOut, nint/* nint */ pPinCategoryOut);
}
