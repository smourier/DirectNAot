...
public partial interface ID2D1DeviceContext7 : ID2D1DeviceContext6
{
    ...
    [PreserveSig]
    public void DrawGlyphRunWithColorSupport(D2D_POINT_2F baselineOrigin, in DWRITE_GLYPH_RUN glyphRun, nint /* DWRITE_GLYPH_RUN_DESCRIPTION */ glyphRunDescription, ID2D1Brush foregroundBrush, ID2D1SvgGlyphStyle svgGlyphStyle, uint colorPaletteIndex, DWRITE_MEASURING_MODE measuringMode, D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION bitmapSnapOption);
}
