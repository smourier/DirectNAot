...
public partial interface ID2D1PathGeometry1 : ID2D1PathGeometry
{
    ...
    public HRESULT ComputePointAndSegmentAtLength(float length, uint startSegment, nint/* nint */ worldTransform, float flatteningTolerance, out D2D1_POINT_DESCRIPTION pointDescription);
}
