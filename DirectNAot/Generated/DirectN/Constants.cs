...
public static partial class Constants
{
    ...
    public const uint AC_SRC_ALPHA = 1;
    
    public const uint AC_SRC_OVER = 0;
    ...
    public const uint APD_COPY_ALL_FILES = 4;
    
    public const uint APD_COPY_FROM_DIRECTORY = 16;
    
    public const uint APD_COPY_NEW_FILES = 8;
    
    public const uint APD_STRICT_DOWNGRADE = 2;
    
    public const uint APD_STRICT_UPGRADE = 1;
    
    public const uint APPLYCPSUI_NO_NEWDEF = 1;
    
    public const uint APPLYCPSUI_OK_CANCEL_BUTTON = 2;
    
    public const uint ASPECT_FILTERING = 1;
    
    public const uint BANDINFO = 24;
    
    public const uint BEGIN_PATH = 4096;
    
    public const uint BIDI_ACCESS_ADMINISTRATOR = 1;
    
    public const uint BIDI_ACCESS_USER = 2;
    ...
    public const uint BOOKLET_EDGE_LEFT = 0;
    
    public const uint BOOKLET_EDGE_RIGHT = 1;
    
    public const uint BOOKLET_PRINT = 2;
    
    public const uint BORDER_PRINT = 0;
    ...
    public const uint CA_LOG_FILTER = 2;
    
    public const uint CA_NEGATIVE = 1;
    ...
    public const uint CC_NOPRECNV = 65535;
    ...
    public const uint CDM_CONVERT = 1;
    
    public const uint CDM_CONVERT351 = 2;
    
    public const uint CDM_DRIVER_DEFAULT = 4;
    ...
    public const uint CLR_INVALID = 4294967295;
    ...
    public static readonly Guid CLSID_OEMPTPROVIDER = new("91723892-45d2-48e2-9ec9-562379daf992");
    
    public static readonly Guid CLSID_OEMRENDER = new("6d6abf26-9f38-11d1-882a-00c04fb961ec");
    
    public static readonly Guid CLSID_OEMUI = new("abce80d7-9f46-11d1-882a-00c04fb961ec");
    
    public static readonly Guid CLSID_OEMUIMXDC = new("4e144300-5b43-4288-932a-5e4dd6d82bed");
    
    public static readonly Guid CLSID_PTPROVIDER = new("46ac151b-8490-4531-96cc-55bf2bf19e11");
    ...
    public const uint CM_CMYK_COLOR = 4;
    
    public const uint CM_DEVICE_ICM = 1;
    
    public const uint CM_GAMMA_RAMP = 2;
    
    public const uint CM_IN_GAMUT = 0;
    
    public const uint CM_NONE = 0;
    ...
    public const uint COLOR_OPTIMIZATION = 1;
    ...
    public const uint COLORMATCHTOTARGET_EMBEDED = 1;
    ...
    public const uint COPYFILE_FLAG_CLIENT_SPOOLER = 1;
    
    public const uint COPYFILE_FLAG_SERVER_SPOOLER = 2;
    ...
    public const uint CPSFUNC_INSERT_PSUIPAGE = 17;
    ...
    public const uint CPSFUNC_LOAD_CPSUI_STRING = 12;
    ...
    public const uint CPSFUNC_SET_PSUIPAGE_TITLE = 19;
    ...
    public const uint CPSUIF_ABOUT_CALLBACK = 4;
    
    public const uint CPSUIF_ICONID_AS_HICON = 2;
    
    public const uint CPSUIF_UPDATE_PERMISSION = 1;
    
    public const uint CREATECOLORSPACE_EMBEDED = 1;
    ...
    public const uint DCBA_FACEDOWNCENTER = 257;
    
    public const uint DCBA_FACEDOWNLEFT = 258;
    
    public const uint DCBA_FACEDOWNNONE = 256;
    
    public const uint DCBA_FACEDOWNRIGHT = 259;
    
    public const uint DCBA_FACEUPCENTER = 1;
    
    public const uint DCBA_FACEUPLEFT = 2;
    
    public const uint DCBA_FACEUPNONE = 0;
    
    public const uint DCBA_FACEUPRIGHT = 3;
    ...
    public const uint DEVICE_FONTTYPE = 2;
    ...
    public const uint DF_NO_DOUBLE_UNDERLINE = 16;
    
    public const uint DF_NO_STRIKETHRU = 32;
    
    public const uint DF_NOITALIC = 1;
    
    public const uint DF_NOUNDER = 2;
    ...
    public const uint DF_XM_CR = 4;
    
    public const uint DI_APPBANDING = 1;
    
    public const uint DI_CHANNEL = 1;
    
    public const uint DI_MEMORYMAP_WRITE = 1;
    
    public const uint DI_READ_SPOOL_JOB = 3;
    
    public const uint DI_ROPS_READ_DESTINATION = 2;
    ...
    public const uint DISPID_PRINTEREXTENSION_CONTEXT = 11800;
    
    public const uint DISPID_PRINTEREXTENSION_CONTEXT_DRIVERPROPERTIES = 11803;
    
    public const uint DISPID_PRINTEREXTENSION_CONTEXT_PRINTERQUEUE = 11801;
    
    public const uint DISPID_PRINTEREXTENSION_CONTEXT_PRINTSCHEMATICKET = 11802;
    
    public const uint DISPID_PRINTEREXTENSION_CONTEXT_USERPROPERTIES = 11804;
    
    public const uint DISPID_PRINTEREXTENSION_CONTEXTCOLLECTION = 12100;
    
    public const uint DISPID_PRINTEREXTENSION_CONTEXTCOLLECTION_COUNT = 12101;
    
    public const uint DISPID_PRINTEREXTENSION_CONTEXTCOLLECTION_GETAT = 12102;
    
    public const uint DISPID_PRINTEREXTENSION_EVENT = 12200;
    
    public const uint DISPID_PRINTEREXTENSION_EVENT_ONDRIVEREVENT = 12201;
    
    public const uint DISPID_PRINTEREXTENSION_EVENT_ONPRINTERQUEUESENUMERATED = 12202;
    
    public const uint DISPID_PRINTEREXTENSION_EVENTARGS = 12000;
    
    public const uint DISPID_PRINTEREXTENSION_EVENTARGS_BIDINOTIFICATION = 12001;
    
    public const uint DISPID_PRINTEREXTENSION_EVENTARGS_DETAILEDREASONID = 12005;
    
    public const uint DISPID_PRINTEREXTENSION_EVENTARGS_REASONID = 12002;
    
    public const uint DISPID_PRINTEREXTENSION_EVENTARGS_REQUEST = 12003;
    
    public const uint DISPID_PRINTEREXTENSION_EVENTARGS_SOURCEAPPLICATION = 12004;
    
    public const uint DISPID_PRINTEREXTENSION_EVENTARGS_WINDOWMODAL = 12006;
    
    public const uint DISPID_PRINTEREXTENSION_EVENTARGS_WINDOWPARENT = 12007;
    
    public const uint DISPID_PRINTEREXTENSION_REQUEST = 11900;
    
    public const uint DISPID_PRINTEREXTENSION_REQUEST_CANCEL = 11901;
    
    public const uint DISPID_PRINTEREXTENSION_REQUEST_COMPLETE = 11902;
    
    public const uint DISPID_PRINTERPROPERTYBAG = 11400;
    
    public const uint DISPID_PRINTERPROPERTYBAG_GETBOOL = 11401;
    
    public const uint DISPID_PRINTERPROPERTYBAG_GETBYTES = 11407;
    
    public const uint DISPID_PRINTERPROPERTYBAG_GETINT32 = 11403;
    
    public const uint DISPID_PRINTERPROPERTYBAG_GETREADSTREAM = 11409;
    
    public const uint DISPID_PRINTERPROPERTYBAG_GETSTRING = 11405;
    
    public const uint DISPID_PRINTERPROPERTYBAG_GETWRITESTREAM = 11410;
    
    public const uint DISPID_PRINTERPROPERTYBAG_SETBOOL = 11402;
    
    public const uint DISPID_PRINTERPROPERTYBAG_SETBYTES = 11408;
    
    public const uint DISPID_PRINTERPROPERTYBAG_SETINT32 = 11404;
    
    public const uint DISPID_PRINTERPROPERTYBAG_SETSTRING = 11406;
    
    public const uint DISPID_PRINTERQUEUE = 11600;
    
    public const uint DISPID_PRINTERQUEUE_GETPRINTERQUEUEVIEW = 11606;
    
    public const uint DISPID_PRINTERQUEUE_GETPROPERTIES = 11604;
    
    public const uint DISPID_PRINTERQUEUE_HANDLE = 11601;
    
    public const uint DISPID_PRINTERQUEUE_NAME = 11602;
    
    public const uint DISPID_PRINTERQUEUE_SENDBIDIQUERY = 11603;
    
    public const uint DISPID_PRINTERQUEUE_SENDBIDISETREQUESTASYNC = 11605;
    
    public const uint DISPID_PRINTERQUEUEEVENT = 11700;
    
    public const uint DISPID_PRINTERQUEUEEVENT_ONBIDIRESPONSERECEIVED = 11701;
    
    public const uint DISPID_PRINTERQUEUEVIEW = 12700;
    
    public const uint DISPID_PRINTERQUEUEVIEW_EVENT = 12800;
    
    public const uint DISPID_PRINTERQUEUEVIEW_EVENT_ONCHANGED = 12801;
    
    public const uint DISPID_PRINTERQUEUEVIEW_SETVIEWRANGE = 12701;
    
    public const uint DISPID_PRINTERSCRIPTABLEPROPERTYBAG = 11500;
    
    public const uint DISPID_PRINTERSCRIPTABLEPROPERTYBAG_GETBOOL = 11501;
    
    public const uint DISPID_PRINTERSCRIPTABLEPROPERTYBAG_GETBYTES = 11507;
    
    public const uint DISPID_PRINTERSCRIPTABLEPROPERTYBAG_GETINT32 = 11503;
    
    public const uint DISPID_PRINTERSCRIPTABLEPROPERTYBAG_GETREADSTREAM = 11509;
    
    public const uint DISPID_PRINTERSCRIPTABLEPROPERTYBAG_GETSTREAMASXML = 11411;
    
    public const uint DISPID_PRINTERSCRIPTABLEPROPERTYBAG_GETSTRING = 11505;
    
    public const uint DISPID_PRINTERSCRIPTABLEPROPERTYBAG_GETWRITESTREAM = 11510;
    
    public const uint DISPID_PRINTERSCRIPTABLEPROPERTYBAG_SETBOOL = 11502;
    
    public const uint DISPID_PRINTERSCRIPTABLEPROPERTYBAG_SETBYTES = 11508;
    
    public const uint DISPID_PRINTERSCRIPTABLEPROPERTYBAG_SETINT32 = 11504;
    
    public const uint DISPID_PRINTERSCRIPTABLEPROPERTYBAG_SETSTRING = 11506;
    
    public const uint DISPID_PRINTERSCRIPTABLESEQUENTIALSTREAM = 11200;
    
    public const uint DISPID_PRINTERSCRIPTABLESEQUENTIALSTREAM_READ = 11201;
    
    public const uint DISPID_PRINTERSCRIPTABLESEQUENTIALSTREAM_WRITE = 11202;
    
    public const uint DISPID_PRINTERSCRIPTABLESTREAM = 11300;
    
    public const uint DISPID_PRINTERSCRIPTABLESTREAM_COMMIT = 11301;
    
    public const uint DISPID_PRINTERSCRIPTABLESTREAM_SEEK = 11302;
    
    public const uint DISPID_PRINTERSCRIPTABLESTREAM_SETSIZE = 11303;
    
    public const uint DISPID_PRINTERSCRIPTCONTEXT = 12300;
    
    public const uint DISPID_PRINTERSCRIPTCONTEXT_DRIVERPROPERTIES = 12301;
    
    public const uint DISPID_PRINTERSCRIPTCONTEXT_QUEUEPROPERTIES = 12302;
    
    public const uint DISPID_PRINTERSCRIPTCONTEXT_USERPROPERTIES = 12303;
    
    public const uint DISPID_PRINTJOBCOLLECTION = 12600;
    
    public const uint DISPID_PRINTJOBCOLLECTION_COUNT = 12601;
    
    public const uint DISPID_PRINTJOBCOLLECTION_GETAT = 12602;
    
    public const uint DISPID_PRINTSCHEMA_ASYNCOPERATION = 10900;
    
    public const uint DISPID_PRINTSCHEMA_ASYNCOPERATION_CANCEL = 10902;
    
    public const uint DISPID_PRINTSCHEMA_ASYNCOPERATION_START = 10901;
    
    public const uint DISPID_PRINTSCHEMA_ASYNCOPERATIONEVENT = 11100;
    
    public const uint DISPID_PRINTSCHEMA_ASYNCOPERATIONEVENT_COMPLETED = 11101;
    
    public const uint DISPID_PRINTSCHEMA_CAPABILITIES = 10800;
    
    public const uint DISPID_PRINTSCHEMA_CAPABILITIES_GETFEATURE = 10802;
    
    public const uint DISPID_PRINTSCHEMA_CAPABILITIES_GETFEATURE_KEYNAME = 10801;
    
    public const uint DISPID_PRINTSCHEMA_CAPABILITIES_GETOPTIONS = 10807;
    
    public const uint DISPID_PRINTSCHEMA_CAPABILITIES_GETPARAMETERDEFINITION = 10808;
    
    public const uint DISPID_PRINTSCHEMA_CAPABILITIES_GETSELECTEDOPTION = 10806;
    
    public const uint DISPID_PRINTSCHEMA_CAPABILITIES_JOBCOPIESMAXVALUE = 10805;
    
    public const uint DISPID_PRINTSCHEMA_CAPABILITIES_JOBCOPIESMINVALUE = 10804;
    
    public const uint DISPID_PRINTSCHEMA_CAPABILITIES_PAGEIMAGEABLESIZE = 10803;
    
    public const uint DISPID_PRINTSCHEMA_DISPLAYABLEELEMENT = 10100;
    
    public const uint DISPID_PRINTSCHEMA_DISPLAYABLEELEMENT_DISPLAYNAME = 10101;
    
    public const uint DISPID_PRINTSCHEMA_ELEMENT = 10000;
    
    public const uint DISPID_PRINTSCHEMA_ELEMENT_NAME = 10002;
    
    public const uint DISPID_PRINTSCHEMA_ELEMENT_NAMESPACEURI = 10003;
    
    public const uint DISPID_PRINTSCHEMA_ELEMENT_XMLNODE = 10001;
    
    public const uint DISPID_PRINTSCHEMA_FEATURE = 10600;
    
    public const uint DISPID_PRINTSCHEMA_FEATURE_DISPLAYUI = 10604;
    
    public const uint DISPID_PRINTSCHEMA_FEATURE_GETOPTION = 10603;
    
    public const uint DISPID_PRINTSCHEMA_FEATURE_SELECTEDOPTION = 10601;
    
    public const uint DISPID_PRINTSCHEMA_FEATURE_SELECTIONTYPE = 10602;
    
    public const uint DISPID_PRINTSCHEMA_NUPOPTION = 10400;
    
    public const uint DISPID_PRINTSCHEMA_NUPOPTION_PAGESPERSHEET = 10401;
    
    public const uint DISPID_PRINTSCHEMA_OPTION = 10200;
    
    public const uint DISPID_PRINTSCHEMA_OPTION_CONSTRAINED = 10202;
    
    public const uint DISPID_PRINTSCHEMA_OPTION_GETPROPERTYVALUE = 10203;
    
    public const uint DISPID_PRINTSCHEMA_OPTION_SELECTED = 10201;
    
    public const uint DISPID_PRINTSCHEMA_OPTIONCOLLECTION = 10500;
    
    public const uint DISPID_PRINTSCHEMA_OPTIONCOLLECTION_COUNT = 10501;
    
    public const uint DISPID_PRINTSCHEMA_OPTIONCOLLECTION_GETAT = 10502;
    
    public const uint DISPID_PRINTSCHEMA_PAGEIMAGEABLESIZE = 10700;
    
    public const uint DISPID_PRINTSCHEMA_PAGEIMAGEABLESIZE_EXTENT_HEIGHT = 10706;
    
    public const uint DISPID_PRINTSCHEMA_PAGEIMAGEABLESIZE_EXTENT_WIDTH = 10705;
    
    public const uint DISPID_PRINTSCHEMA_PAGEIMAGEABLESIZE_IMAGEABLE_HEIGHT = 10702;
    
    public const uint DISPID_PRINTSCHEMA_PAGEIMAGEABLESIZE_IMAGEABLE_WIDTH = 10701;
    
    public const uint DISPID_PRINTSCHEMA_PAGEIMAGEABLESIZE_ORIGIN_HEIGHT = 10704;
    
    public const uint DISPID_PRINTSCHEMA_PAGEIMAGEABLESIZE_ORIGIN_WIDTH = 10703;
    
    public const uint DISPID_PRINTSCHEMA_PAGEMEDIASIZEOPTION = 10300;
    
    public const uint DISPID_PRINTSCHEMA_PAGEMEDIASIZEOPTION_HEIGHT = 10302;
    
    public const uint DISPID_PRINTSCHEMA_PAGEMEDIASIZEOPTION_WIDTH = 10301;
    
    public const uint DISPID_PRINTSCHEMA_PARAMETERDEFINITION = 12500;
    
    public const uint DISPID_PRINTSCHEMA_PARAMETERDEFINITION_DATATYPE = 12503;
    
    public const uint DISPID_PRINTSCHEMA_PARAMETERDEFINITION_RANGEMAX = 12505;
    
    public const uint DISPID_PRINTSCHEMA_PARAMETERDEFINITION_RANGEMIN = 12504;
    
    public const uint DISPID_PRINTSCHEMA_PARAMETERDEFINITION_UNITTYPE = 12502;
    
    public const uint DISPID_PRINTSCHEMA_PARAMETERDEFINITION_USERINPUTREQUIRED = 12501;
    
    public const uint DISPID_PRINTSCHEMA_PARAMETERINITIALIZER = 12400;
    
    public const uint DISPID_PRINTSCHEMA_PARAMETERINITIALIZER_VALUE = 12401;
    
    public const uint DISPID_PRINTSCHEMA_TICKET = 11000;
    
    public const uint DISPID_PRINTSCHEMA_TICKET_COMMITASYNC = 11004;
    
    public const uint DISPID_PRINTSCHEMA_TICKET_GETCAPABILITIES = 11006;
    
    public const uint DISPID_PRINTSCHEMA_TICKET_GETFEATURE = 11002;
    
    public const uint DISPID_PRINTSCHEMA_TICKET_GETFEATURE_KEYNAME = 11001;
    
    public const uint DISPID_PRINTSCHEMA_TICKET_GETPARAMETERINITIALIZER = 11008;
    
    public const uint DISPID_PRINTSCHEMA_TICKET_JOBCOPIESALLDOCUMENTS = 11007;
    
    public const uint DISPID_PRINTSCHEMA_TICKET_NOTIFYXMLCHANGED = 11005;
    
    public const uint DISPID_PRINTSCHEMA_TICKET_VALIDATEASYNC = 11003;
    
    public const uint DISPLAY_DEVICE_ACC_DRIVER = 64;
    
    public const uint DISPLAY_DEVICE_ACTIVE = 1;
    
    public const uint DISPLAY_DEVICE_ATTACHED = 2;
    
    public const uint DISPLAY_DEVICE_ATTACHED_TO_DESKTOP = 1;
    
    public const uint DISPLAY_DEVICE_DISCONNECT = 33554432;
    
    public const uint DISPLAY_DEVICE_MIRRORING_DRIVER = 8;
    
    public const uint DISPLAY_DEVICE_MODESPRUNED = 134217728;
    
    public const uint DISPLAY_DEVICE_MULTI_DRIVER = 2;
    
    public const uint DISPLAY_DEVICE_PRIMARY_DEVICE = 4;
    
    public const uint DISPLAY_DEVICE_RDPUDD = 16777216;
    
    public const uint DISPLAY_DEVICE_REMOTE = 67108864;
    
    public const uint DISPLAY_DEVICE_REMOVABLE = 32;
    
    public const uint DISPLAY_DEVICE_TS_COMPATIBLE = 2097152;
    
    public const uint DISPLAY_DEVICE_UNSAFE_MODES_ON = 524288;
    
    public const uint DISPLAY_DEVICE_VGA_COMPATIBLE = 16;
    
    public const uint DISPLAYCONFIG_MAXPATH = 1024;
    
    public const uint DISPLAYCONFIG_PATH_ACTIVE = 1;
    
    public const uint DISPLAYCONFIG_PATH_CLONE_GROUP_INVALID = 65535;
    
    public const uint DISPLAYCONFIG_PATH_DESKTOP_IMAGE_IDX_INVALID = 65535;
    
    public const uint DISPLAYCONFIG_PATH_MODE_IDX_INVALID = 4294967295;
    
    public const uint DISPLAYCONFIG_PATH_PREFERRED_UNSCALED = 4;
    
    public const uint DISPLAYCONFIG_PATH_SOURCE_MODE_IDX_INVALID = 65535;
    
    public const uint DISPLAYCONFIG_PATH_SUPPORT_VIRTUAL_MODE = 8;
    
    public const uint DISPLAYCONFIG_PATH_TARGET_MODE_IDX_INVALID = 65535;
    
    public const uint DISPLAYCONFIG_PATH_VALID_FLAGS = 29;
    
    public const uint DISPLAYCONFIG_SOURCE_IN_USE = 1;
    
    public const uint DISPLAYCONFIG_TARGET_FORCED_AVAILABILITY_BOOT = 4;
    
    public const uint DISPLAYCONFIG_TARGET_FORCED_AVAILABILITY_PATH = 8;
    
    public const uint DISPLAYCONFIG_TARGET_FORCED_AVAILABILITY_SYSTEM = 16;
    
    public const uint DISPLAYCONFIG_TARGET_FORCIBLE = 2;
    
    public const uint DISPLAYCONFIG_TARGET_IN_USE = 1;
    
    public const uint DISPLAYCONFIG_TARGET_IS_HMD = 32;
    
    public const uint DM_ADVANCED = 16;
    
    public const uint DM_INVALIDATE_DRIVER_CACHE = 536870912;
    
    public const uint DM_NOPERMISSION = 32;
    
    public const uint DM_PROMPT_NON_MODAL = 1073741824;
    
    public const uint DM_RESERVED = 2147483648;
    
    public const uint DM_USER_DEFAULT = 64;
    ...
    public const uint DMBIN_LAST = 15;
    ...
    public const uint DMDISPLAYFLAGS_TEXTMODE = 4;
    ...
    public const uint DMPAPER_LAST = 118;
    ...
    public const uint DOC_INFO_INTERNAL_LEVEL = 100;
    ...
    public const uint DOCUMENTEVENT_SPOOLED = 65536;
    ...
    public const uint DP_STD_DOCPROPPAGE1 = 65533;
    
    public const uint DP_STD_DOCPROPPAGE2 = 65534;
    
    public const uint DP_STD_RESERVED_START = 65520;
    
    public const uint DP_STD_TREEVIEWPAGE = 65535;
    
    public const uint DPD_DELETE_ALL_FILES = 4;
    
    public const uint DPD_DELETE_SPECIFIC_VERSION = 2;
    
    public const uint DPD_DELETE_UNUSED_FILES = 1;
    
    public const uint DPF_ICONID_AS_HICON = 1;
    
    public const uint DPF_USE_HDLGTEMPLATE = 2;
    
    public const uint DPS_NOPERMISSION = 1;
    
    public const uint DRAFTMODE = 7;
    
    public const uint DRAWPATTERNRECT = 25;
    
    public const uint DRIVER_EVENT_DELETE = 2;
    
    public const uint DRIVER_EVENT_INITIALIZE = 1;
    
    public const uint DRIVER_KERNELMODE = 1;
    
    public const uint DRIVER_USERMODE = 2;
    
    public const uint DSPRINT_PENDING = 2147483648;
    
    public const uint DSPRINT_PUBLISH = 1;
    
    public const uint DSPRINT_REPUBLISH = 8;
    
    public const uint DSPRINT_UNPUBLISH = 4;
    
    public const uint DSPRINT_UPDATE = 2;
    ...
    public const int E_ADDFONTFAILED = 512;
    
    public const int E_API_NOTIMPL = 1;
    
    public const int E_CHARCODECOUNTINVALID = 2;
    
    public const int E_CHARCODESETINVALID = 3;
    
    public const int E_CHARSETINVALID = 21;
    
    public const int E_COULDNTCREATETEMPFILE = 513;
    
    public const uint E_DELTA_PRINTTICKET_FORMAT = 2147745797;
    
    public const int E_DEVICETRUETYPEFONT = 4;
    
    public const int E_ERRORACCESSINGEXCLUDELIST = 274;
    
    public const int E_ERRORACCESSINGFACENAME = 13;
    
    public const int E_ERRORACCESSINGFONTDATA = 12;
    
    public const int E_ERRORCOMPRESSINGFONTDATA = 256;
    
    public const int E_ERRORCONVERTINGCHARS = 18;
    
    public const int E_ERRORCREATINGFONTFILE = 269;
    
    public const int E_ERRORDECOMPRESSINGFONTDATA = 273;
    
    public const int E_ERROREXPANDINGFONTDATA = 519;
    
    public const int E_ERRORGETTINGDC = 520;
    
    public const int E_ERRORREADINGFONTDATA = 267;
    
    public const int E_ERRORUNICODECONVERSION = 17;
    
    public const int E_EXCEPTION = 19;
    
    public const int E_EXCEPTIONINCOMPRESSION = 522;
    
    public const int E_EXCEPTIONINDECOMPRESSION = 521;
    
    public const int E_FACENAMEINVALID = 275;
    
    public const int E_FILE_NOT_FOUND = 23;
    
    public const int E_FLAGSINVALID = 268;
    
    public const int E_FONTALREADYEXISTS = 270;
    
    public const int E_FONTDATAINVALID = 258;
    
    public const int E_FONTFAMILYNAMENOTINFULL = 285;
    
    public const int E_FONTFILECREATEFAILED = 515;
    
    public const int E_FONTFILENOTFOUND = 517;
    
    public const int E_FONTINSTALLFAILED = 272;
    
    public const int E_FONTNAMEALREADYEXISTS = 271;
    
    public const int E_FONTNOTEMBEDDABLE = 260;
    
    public const int E_FONTREFERENCEINVALID = 8;
    
    public const int E_FONTVARIATIONSIMULATED = 283;
    
    public const int E_HDCINVALID = 6;
    
    public const int E_INPUTPARAMINVALID = 25;
    
    public const int E_NAMECHANGEFAILED = 259;
    
    public const int E_NOFREEMEMORY = 7;
    
    public const int E_NONE = 0;
    
    public const int E_NOOS2 = 265;
    
    public const int E_NOTATRUETYPEFONT = 10;
    
    public const int E_PBENABLEDINVALID = 280;
    
    public const int E_PERMISSIONSINVALID = 279;
    
    public const uint E_PRINTCAPABILITIES_FORMAT = 2147745796;
    
    public const uint E_PRINTDEVICECAPABILITIES_FORMAT = 2147745798;
    
    public const uint E_PRINTTICKET_FORMAT = 2147745795;
    
    public const int E_PRIVSINVALID = 261;
    
    public const int E_PRIVSTATUSINVALID = 278;
    
    public const int E_READFROMSTREAMFAILED = 263;
    
    public const int E_RESERVEDPARAMNOTNULL = 20;
    
    public const int E_RESOURCEFILECREATEFAILED = 518;
    
    public const int E_SAVETOSTREAMFAILED = 264;
    
    public const int E_STATUSINVALID = 277;
    
    public const int E_STREAMINVALID = 276;
    
    public const int E_SUBSETTINGEXCEPTION = 281;
    
    public const int E_SUBSETTINGFAILED = 262;
    
    public const int E_SUBSTRING_TEST_FAIL = 282;
    
    public const int E_T2NOFREEMEMORY = 266;
    
    public const int E_TTC_INDEX_OUT_OF_RANGE = 24;
    
    public const uint E_VERSION_NOT_SUPPORTED = 2147745793;
    
    public const int E_WINDOWSAPI = 516;
    
    public const uint ECBF_CHECKNAME_AT_FRONT = 1;
    
    public const uint ECBF_CHECKNAME_ONLY = 128;
    
    public const uint ECBF_CHECKNAME_ONLY_ENABLED = 2;
    
    public const uint ECBF_ICONID_AS_HICON = 4;
    
    public const uint ECBF_MASK = 255;
    
    public const uint ECBF_OVERLAY_ECBICON_IF_CHECKED = 16;
    
    public const uint ECBF_OVERLAY_NO_ICON = 64;
    
    public const uint ECBF_OVERLAY_STOP_ICON = 32;
    
    public const uint ECBF_OVERLAY_WARNING_ICON = 8;
    ...
    public const uint EMF_PP_COLOR_OPTIMIZATION = 1;
    ...
    public const uint ENHMETA_SIGNATURE = 1179469088;
    
    public const uint ENHMETA_STOCK_OBJECT = 2147483648;
    
    public const uint ENUMPAPERBINS = 31;
    
    public const uint ENUMPAPERMETRICS = 34;
    
    public const uint EPF_ICONID_AS_HICON = 8;
    
    public const uint EPF_INCL_SETUP_TITLE = 2;
    
    public const uint EPF_MASK = 255;
    
    public const uint EPF_NO_DOT_DOT_DOT = 4;
    
    public const uint EPF_OVERLAY_NO_ICON = 64;
    
    public const uint EPF_OVERLAY_STOP_ICON = 32;
    
    public const uint EPF_OVERLAY_WARNING_ICON = 16;
    
    public const uint EPF_PUSH_TYPE_DLGPROC = 1;
    
    public const uint EPF_USE_HDLGTEMPLATE = 128;
    
    public const uint EPS_SIGNATURE = 1179865157;
    ...
    public const uint ERROR_BIDI_DEVICE_CONFIG_UNCHANGED = 13014;
    
    public const uint ERROR_BIDI_DEVICE_OFFLINE = 13004;
    
    public const uint ERROR_BIDI_ERROR_BASE = 13000;
    
    public const uint ERROR_BIDI_GET_ARGUMENT_NOT_SUPPORTED = 13012;
    
    public const uint ERROR_BIDI_GET_MISSING_ARGUMENT = 13013;
    
    public const uint ERROR_BIDI_GET_REQUIRES_ARGUMENT = 13011;
    
    public const uint ERROR_BIDI_NO_BIDI_SCHEMA_EXTENSIONS = 13016;
    
    public const uint ERROR_BIDI_NO_LOCALIZED_RESOURCES = 13015;
    
    public const uint ERROR_BIDI_SCHEMA_NOT_SUPPORTED = 13005;
    
    public const uint ERROR_BIDI_SCHEMA_READ_ONLY = 13002;
    
    public const uint ERROR_BIDI_SCHEMA_WRITE_ONLY = 13010;
    
    public const uint ERROR_BIDI_SERVER_OFFLINE = 13003;
    
    public const uint ERROR_BIDI_SET_DIFFERENT_TYPE = 13006;
    
    public const uint ERROR_BIDI_SET_INVALID_SCHEMAPATH = 13008;
    
    public const uint ERROR_BIDI_SET_MULTIPLE_SCHEMAPATH = 13007;
    
    public const uint ERROR_BIDI_SET_UNKNOWN_FAILURE = 13009;
    
    public const uint ERROR_BIDI_STATUS_OK = 0;
    
    public const uint ERROR_BIDI_STATUS_WARNING = 13001;
    
    public const uint ERROR_BIDI_UNSUPPORTED_CLIENT_LANGUAGE = 13017;
    
    public const uint ERROR_BIDI_UNSUPPORTED_RESOURCE_FORMAT = 13018;
    ...
    public const uint FEATURESETTING_PRIVATE_BEGIN = 4096;
    
    public const uint FEATURESETTING_PRIVATE_END = 8191;
    
    public const uint FEATURESETTING_PROTOCOL = 6;
    
    public const uint FEATURESETTING_PSLEVEL = 2;
    
    public const uint FG_CANCHANGE = 128;
    
    public const uint FILL_WITH_DEFAULTS = 1;
    
    public const float FlatnessDefault = 0.25f;
    
    public const int FLI_GLYPHS = 262144;
    
    public const uint FLI_MASK = 4155;
    
    public const uint FLUSHOUTPUT = 6;
    
    public static readonly Guid FMTID_PrinterPropertyBag = new("75f9adca-097d-45c3-a6e4-bab29e276f3e");
    ...
    public const uint FONT_DIR_SORTED = 1;
    
    public const uint FONT_FL_DEVICEFONT = 16;
    
    public const uint FONT_FL_GLYPHSET_GTT = 32;
    
    public const uint FONT_FL_GLYPHSET_RLE = 64;
    
    public const uint FONT_FL_IFI = 2;
    
    public const uint FONT_FL_PERMANENT_SF = 8;
    
    public const uint FONT_FL_RESERVED = 32768;
    
    public const uint FONT_FL_SOFTFONT = 4;
    
    public const uint FONT_FL_UFM = 1;
    
    public const uint FONTMAPPER_MAX = 10;
    
    public const uint FORM_BUILTIN = 1;
    
    public const uint FORM_PRINTER = 2;
    
    public const uint FORM_USER = 0;
    ...
    public const uint GCP_DBCS = 1;
    
    public const uint GCP_ERROR = 32768;
    ...
    public const uint GCPCLASS_POSTBOUNDLTR = 32;
    
    public const uint GCPCLASS_POSTBOUNDRTL = 16;
    
    public const uint GCPCLASS_PREBOUNDLTR = 128;
    
    public const uint GCPCLASS_PREBOUNDRTL = 64;
    
    public const uint GCPGLYPH_LINKAFTER = 16384;
    
    public const uint GCPGLYPH_LINKBEFORE = 32768;
    
    public const int GDI_ERROR = -1;
    
    public const uint GDICOMMENT_BEGINGROUP = 2;
    
    public const uint GDICOMMENT_ENDGROUP = 3;
    
    public const uint GDICOMMENT_IDENTIFIER = 1128875079;
    
    public const uint GDICOMMENT_MULTIFORMATS = 1073741828;
    
    public const uint GDICOMMENT_UNICODE_END = 128;
    
    public const uint GDICOMMENT_UNICODE_STRING = 64;
    
    public const uint GDICOMMENT_WINDOWS_METAFILE = 2147483649;
    ...
    public const uint GDIREGISTERDDRAWPACKETVERSION = 1;
    ...
    public const uint GGI_MARK_NONEXISTING_GLYPHS = 1;
    ...
    public const uint GRADIENT_FILL_OP_FLAG = 255;
    
    public const uint GREEN_SHIFT = 8;
    
    public const uint GS_8BIT_INDICES = 1;
    ...
    public const uint ILLUMINANT_DAYLIGHT = 3;
    
    public const uint ILLUMINANT_DEVICE_DEFAULT = 0;
    
    public const uint ILLUMINANT_F2 = 8;
    
    public const uint ILLUMINANT_FLUORESCENT = 8;
    
    public const uint ILLUMINANT_MAX_INDEX = 8;
    
    public const uint ILLUMINANT_NTSC = 3;
    
    public const uint ILLUMINANT_TUNGSTEN = 1;
    ...
    public const uint IOCTL_USBPRINT_ADD_CHILD_DEVICE = 2228316;
    
    public const uint IOCTL_USBPRINT_ADD_MSIPP_COMPAT_ID = 2228308;
    
    public const uint IOCTL_USBPRINT_CYCLE_PORT = 2228320;
    
    public const uint IOCTL_USBPRINT_GET_1284_ID = 2228276;
    
    public const uint IOCTL_USBPRINT_GET_INTERFACE_TYPE = 2228300;
    
    public const uint IOCTL_USBPRINT_GET_LPT_STATUS = 2228272;
    
    public const uint IOCTL_USBPRINT_GET_PROTOCOL = 2228292;
    
    public const uint IOCTL_USBPRINT_SET_DEVICE_ID = 2228312;
    
    public const uint IOCTL_USBPRINT_SET_PORT_NUMBER = 2228304;
    
    public const uint IOCTL_USBPRINT_SET_PROTOCOL = 2228296;
    
    public const uint IOCTL_USBPRINT_SOFT_RESET = 2228288;
    
    public const uint IOCTL_USBPRINT_VENDOR_GET_COMMAND = 2228284;
    
    public const uint IOCTL_USBPRINT_VENDOR_SET_COMMAND = 2228280;
    
    public const uint IPDFP_COPY_ALL_FILES = 1;
    
    public const uint IRQINFO_HANDLED = 1;
    
    public const uint IRQINFO_NOTHANDLED = 2;
    
    public const uint JOB_ACCESS_ADMINISTER = 16;
    
    public const uint JOB_ACCESS_READ = 32;
    ...
    public const uint JOB_CONTROL_RELEASE = 9;
    
    public const uint JOB_CONTROL_RESTART = 4;
    
    public const uint JOB_CONTROL_RESUME = 2;
    
    public const uint JOB_CONTROL_RETAIN = 8;
    
    public const uint JOB_CONTROL_SEND_TOAST = 10;
    
    public const uint JOB_CONTROL_SENT_TO_PRINTER = 6;
    
    public const uint JOB_NOTIFY_FIELD_BYTES_PRINTED = 23;
    
    public const uint JOB_NOTIFY_FIELD_DATATYPE = 5;
    
    public const uint JOB_NOTIFY_FIELD_DEVMODE = 9;
    
    public const uint JOB_NOTIFY_FIELD_DOCUMENT = 13;
    
    public const uint JOB_NOTIFY_FIELD_DRIVER_NAME = 8;
    
    public const uint JOB_NOTIFY_FIELD_MACHINE_NAME = 1;
    
    public const uint JOB_NOTIFY_FIELD_NOTIFY_NAME = 4;
    
    public const uint JOB_NOTIFY_FIELD_PAGES_PRINTED = 21;
    
    public const uint JOB_NOTIFY_FIELD_PARAMETERS = 7;
    
    public const uint JOB_NOTIFY_FIELD_PORT_NAME = 2;
    
    public const uint JOB_NOTIFY_FIELD_POSITION = 15;
    
    public const uint JOB_NOTIFY_FIELD_PRINT_PROCESSOR = 6;
    
    public const uint JOB_NOTIFY_FIELD_PRINTER_NAME = 0;
    
    public const uint JOB_NOTIFY_FIELD_PRIORITY = 14;
    
    public const uint JOB_NOTIFY_FIELD_REMOTE_JOB_ID = 24;
    
    public const uint JOB_NOTIFY_FIELD_SECURITY_DESCRIPTOR = 12;
    
    public const uint JOB_NOTIFY_FIELD_START_TIME = 17;
    
    public const uint JOB_NOTIFY_FIELD_STATUS = 10;
    
    public const uint JOB_NOTIFY_FIELD_STATUS_STRING = 11;
    
    public const uint JOB_NOTIFY_FIELD_SUBMITTED = 16;
    
    public const uint JOB_NOTIFY_FIELD_TIME = 19;
    
    public const uint JOB_NOTIFY_FIELD_TOTAL_BYTES = 22;
    
    public const uint JOB_NOTIFY_FIELD_TOTAL_PAGES = 20;
    
    public const uint JOB_NOTIFY_FIELD_UNTIL_TIME = 18;
    
    public const uint JOB_NOTIFY_FIELD_USER_NAME = 3;
    
    public const uint JOB_NOTIFY_TYPE = 1;
    
    public const uint JOB_POSITION_UNSPECIFIED = 0;
    
    public const uint JOB_STATUS_BLOCKED_DEVQ = 512;
    
    public const uint JOB_STATUS_COMPLETE = 4096;
    
    public const uint JOB_STATUS_DELETED = 256;
    
    public const uint JOB_STATUS_DELETING = 4;
    
    public const uint JOB_STATUS_ERROR = 2;
    
    public const uint JOB_STATUS_OFFLINE = 32;
    
    public const uint JOB_STATUS_PAPEROUT = 64;
    
    public const uint JOB_STATUS_PAUSED = 1;
    
    public const uint JOB_STATUS_PRINTED = 128;
    
    public const uint JOB_STATUS_PRINTING = 16;
    
    public const uint JOB_STATUS_RENDERING_LOCALLY = 16384;
    
    public const uint JOB_STATUS_RESTART = 2048;
    
    public const uint JOB_STATUS_RETAINED = 8192;
    
    public const uint JOB_STATUS_SPOOLING = 8;
    
    public const uint JOB_STATUS_USER_INTERVENTION = 1024;
    
    public const uint LAYOUT_BTT = 2;
    
    public const uint LAYOUT_VBH = 4;
    ...
    public const uint LPD_DOUBLEBUFFER = 1;
    
    public const uint LPD_SHARE_ACCUM = 256;
    
    public const uint LPD_SHARE_DEPTH = 64;
    
    public const uint LPD_SHARE_STENCIL = 128;
    
    public const uint LPD_STEREO = 2;
    
    public const uint LPD_SUPPORT_GDI = 16;
    
    public const uint LPD_SUPPORT_OPENGL = 32;
    
    public const uint LPD_SWAP_COPY = 1024;
    
    public const uint LPD_SWAP_EXCHANGE = 512;
    
    public const uint LPD_TRANSPARENT = 4096;
    ...
    public const uint MAX_ADDRESS_STR_LEN = 13;
    ...
    public const uint MAX_DEVICEDESCRIPTION_STR_LEN = 257;
    
    public const uint MAX_DLGPAGE_COUNT = 64;
    
    public const uint MAX_DRIVER_NAME = 32;
    
    public const uint MAX_FORM_KEYWORD_LENGTH = 64;
    
    public const uint MAX_IPADDR_STR_LEN = 16;
    
    public const uint MAX_NETWORKNAME_LEN = 49;
    
    public const uint MAX_NETWORKNAME2_LEN = 128;
    
    public const uint MAX_PALETTE_SIZE = 256;
    
    public const uint MAX_PORTNAME_LEN = 64;
    ...
    public const uint MAX_QUEUENAME_LEN = 33;
    
    public const uint MAX_RES_STR_CHARS = 160;
    
    public const uint MAX_SNMP_COMMUNITY_STR_LEN = 33;
    ...
    public const uint META_ANIMATEPALETTE = 1078;
    
    public const uint META_ARC = 2071;
    
    public const uint META_BITBLT = 2338;
    
    public const uint META_CHORD = 2096;
    
    public const uint META_CREATEBRUSHINDIRECT = 764;
    
    public const uint META_CREATEFONTINDIRECT = 763;
    
    public const uint META_CREATEPALETTE = 247;
    
    public const uint META_CREATEPATTERNBRUSH = 505;
    
    public const uint META_CREATEPENINDIRECT = 762;
    
    public const uint META_CREATEREGION = 1791;
    
    public const uint META_DELETEOBJECT = 496;
    
    public const uint META_DIBBITBLT = 2368;
    
    public const uint META_DIBCREATEPATTERNBRUSH = 322;
    
    public const uint META_DIBSTRETCHBLT = 2881;
    
    public const uint META_ELLIPSE = 1048;
    
    public const uint META_ESCAPE = 1574;
    
    public const uint META_EXCLUDECLIPRECT = 1045;
    
    public const uint META_EXTFLOODFILL = 1352;
    
    public const uint META_EXTTEXTOUT = 2610;
    
    public const uint META_FILLREGION = 552;
    
    public const uint META_FLOODFILL = 1049;
    
    public const uint META_FRAMEREGION = 1065;
    
    public const uint META_INTERSECTCLIPRECT = 1046;
    
    public const uint META_INVERTREGION = 298;
    
    public const uint META_LINETO = 531;
    
    public const uint META_MOVETO = 532;
    
    public const uint META_OFFSETCLIPRGN = 544;
    
    public const uint META_OFFSETVIEWPORTORG = 529;
    
    public const uint META_OFFSETWINDOWORG = 527;
    
    public const uint META_PAINTREGION = 299;
    
    public const uint META_PATBLT = 1565;
    
    public const uint META_PIE = 2074;
    
    public const uint META_POLYGON = 804;
    
    public const uint META_POLYLINE = 805;
    
    public const uint META_POLYPOLYGON = 1336;
    
    public const uint META_REALIZEPALETTE = 53;
    
    public const uint META_RECTANGLE = 1051;
    
    public const uint META_RESIZEPALETTE = 313;
    
    public const uint META_RESTOREDC = 295;
    
    public const uint META_ROUNDRECT = 1564;
    
    public const uint META_SAVEDC = 30;
    
    public const uint META_SCALEVIEWPORTEXT = 1042;
    
    public const uint META_SCALEWINDOWEXT = 1040;
    
    public const uint META_SELECTCLIPREGION = 300;
    
    public const uint META_SELECTOBJECT = 301;
    
    public const uint META_SELECTPALETTE = 564;
    
    public const uint META_SETBKCOLOR = 513;
    
    public const uint META_SETBKMODE = 258;
    
    public const uint META_SETDIBTODEV = 3379;
    
    public const uint META_SETLAYOUT = 329;
    
    public const uint META_SETMAPMODE = 259;
    
    public const uint META_SETMAPPERFLAGS = 561;
    
    public const uint META_SETPALENTRIES = 55;
    
    public const uint META_SETPIXEL = 1055;
    
    public const uint META_SETPOLYFILLMODE = 262;
    
    public const uint META_SETRELABS = 261;
    
    public const uint META_SETROP2 = 260;
    
    public const uint META_SETSTRETCHBLTMODE = 263;
    
    public const uint META_SETTEXTALIGN = 302;
    
    public const uint META_SETTEXTCHAREXTRA = 264;
    
    public const uint META_SETTEXTCOLOR = 521;
    
    public const uint META_SETTEXTJUSTIFICATION = 522;
    
    public const uint META_SETVIEWPORTEXT = 526;
    
    public const uint META_SETVIEWPORTORG = 525;
    
    public const uint META_SETWINDOWEXT = 524;
    
    public const uint META_SETWINDOWORG = 523;
    
    public const uint META_STRETCHBLT = 2851;
    
    public const uint META_STRETCHDIB = 3907;
    
    public const uint META_TEXTOUT = 1313;
    
    public const uint METAFILE_DRIVER = 2049;
    
    public const uint MFCOMMENT = 15;
    
    public const uint MILCORE_TS_QUERYVER_RESULT_FALSE = 0;
    
    public const uint MILCORE_TS_QUERYVER_RESULT_TRUE = 2147483647;
    ...
    public const uint MTYPE_ADD = 64;
    
    public const uint MTYPE_COMPOSE = 1;
    
    public const uint MTYPE_DIRECT = 2;
    
    public const uint MTYPE_DISABLE = 128;
    
    public const uint MTYPE_DOUBLE = 16;
    
    public const uint MTYPE_DOUBLEBYTECHAR_MASK = 24;
    
    public const uint MTYPE_FORMAT_MASK = 7;
    
    public const uint MTYPE_PAIRED = 4;
    
    public const uint MTYPE_PREDEFIN_MASK = 224;
    
    public const uint MTYPE_REPLACE = 32;
    
    public const uint MTYPE_SINGLE = 8;
    
    public const uint MV_GRAPHICS = 4;
    
    public const uint MV_PHYSICAL = 8;
    
    public const uint MV_RELATIVE = 2;
    
    public const uint MV_SENDXMOVECMD = 16;
    
    public const uint MV_SENDYMOVECMD = 32;
    
    public const uint MV_UPDATE = 1;
    ...
    public const uint NEWTRANSPARENT = 3;
    
    public const uint NEXTBAND = 3;
    
    public const uint NO_BORDER_PRINT = 1;
    
    public const uint NO_COLOR_OPTIMIZATION = 0;
    
    public const uint NO_PRIORITY = 0;
    
    public const uint NORMAL_PRINT = 0;
    
    public static readonly Guid NOTIFICATION_RELEASE = new("ba9a5027-a70e-4ae7-9b7d-eb3e06ad4157");
    
    public const int NTM_BOLD = 32;
    
    public const uint NTM_DSIG = 2097152;
    
    public const int NTM_ITALIC = 1;
    
    public const uint NTM_MULTIPLEMASTER = 524288;
    
    public const uint NTM_NONNEGATIVE_AC = 65536;
    
    public const uint NTM_PS_OPENTYPE = 131072;
    
    public const int NTM_REGULAR = 64;
    
    public const uint NTM_TT_OPENTYPE = 262144;
    
    public const uint NTM_TYPE1 = 1048576;
    
    public const int OBJECT_ISROOT = -2147483648;
    
    public const uint OEM_MODE_PUBLISHER = 1;
    ...
    public const uint OEMGDS_FREEMEM = 32769;
    
    public const uint OEMGDS_JOBTIMEOUT = 32770;
    
    public const uint OEMGDS_MAX = 65536;
    
    public const uint OEMGDS_MAXBITMAP = 32774;
    
    public const uint OEMGDS_MIN_DOCSTICKY = 1;
    
    public const uint OEMGDS_MIN_PRINTERSTICKY = 32768;
    
    public const uint OEMGDS_MINOUTLINE = 32773;
    
    public const uint OEMGDS_PRINTFLAGS = 32768;
    
    public const uint OEMGDS_PROTOCOL = 32772;
    ...
    public const uint OEMGDS_UNIDM_FLAGS = 16385;
    
    public const uint OEMGDS_UNIDM_GPDVER = 16384;
    
    public const uint OEMGDS_WAITTIMEOUT = 32771;
    ...
    public const uint OEMPUBLISH_IPRINTCOREHELPER = 1;
    ...
    public const uint OIEXTF_ANSI_STRING = 1;
    
    public const uint OPENCHANNEL = 4110;
    
    public const uint OPTCF_HIDE = 1;
    
    public const uint OPTCF_MASK = 1;
    
    public const int OPTIF_CALLBACK = 4;
    
    public const int OPTIF_CHANGED = 8;
    
    public const int OPTIF_CHANGEONCE = 16;
    
    public const int OPTIF_COLLAPSE = 1;
    
    public const int OPTIF_DISABLED = 32;
    
    public const int OPTIF_ECB_CHECKED = 64;
    
    public const int OPTIF_EXT_DISABLED = 256;
    
    public const int OPTIF_EXT_HIDE = 128;
    
    public const int OPTIF_EXT_IS_EXTPUSH = 1024;
    
    public const int OPTIF_HAS_POIEXT = 65536;
    
    public const int OPTIF_HIDE = 2;
    
    public const int OPTIF_INITIAL_TVITEM = 32768;
    
    public const int OPTIF_MASK = 131071;
    
    public const int OPTIF_NO_GROUPBOX_NAME = 2048;
    
    public const int OPTIF_OVERLAY_NO_ICON = 16384;
    
    public const int OPTIF_OVERLAY_STOP_ICON = 8192;
    
    public const int OPTIF_OVERLAY_WARNING_ICON = 4096;
    
    public const int OPTIF_SEL_AS_HICON = 512;
    
    public const uint OPTPF_DISABLED = 2;
    
    public const uint OPTPF_HIDE = 1;
    
    public const uint OPTPF_ICONID_AS_HICON = 4;
    
    public const uint OPTPF_MASK = 127;
    
    public const uint OPTPF_OVERLAY_NO_ICON = 32;
    
    public const uint OPTPF_OVERLAY_STOP_ICON = 16;
    
    public const uint OPTPF_OVERLAY_WARNING_ICON = 8;
    
    public const uint OPTPF_USE_HDLGTEMPLATE = 64;
    
    public const uint OPTTF_MASK = 3;
    
    public const uint OPTTF_NOSPACE_BEFORE_POSTFIX = 2;
    
    public const uint OPTTF_TYPE_DISABLED = 1;
    
    public const uint OTS_LBCB_INCL_ITEM_NONE = 8;
    
    public const uint OTS_LBCB_NO_ICON16_IN_ITEM = 16;
    
    public const uint OTS_LBCB_PROPPAGE_CBUSELB = 4;
    
    public const uint OTS_LBCB_PROPPAGE_LBUSECB = 2;
    
    public const uint OTS_LBCB_SORT = 1;
    
    public const uint OTS_MASK = 255;
    
    public const uint OTS_PUSH_ENABLE_ALWAYS = 128;
    
    public const uint OTS_PUSH_INCL_SETUP_TITLE = 32;
    
    public const uint OTS_PUSH_NO_DOT_DOT_DOT = 64;
    ...
    public const uint PC_EXPLICIT = 2;
    
    public const uint PC_INTERIORS = 128;
    
    public const uint PC_NOCOLLAPSE = 4;
    ...
    public const uint PC_RESERVED = 1;
    ...
    public const uint PORT_TYPE_NET_ATTACHED = 8;
    
    public const uint PORT_TYPE_READ = 2;
    
    public const uint PORT_TYPE_REDIRECTED = 4;
    
    public const uint PORT_TYPE_WRITE = 1;
    ...
    public const uint PPCAPS_BOOKLET_EDGE = 1;
    
    public const uint PPCAPS_BORDER_PRINT = 1;
    
    public const uint PPCAPS_REVERSE_PAGES_FOR_REVERSE_DUPLEX = 1;
    
    public const uint PPCAPS_RIGHT_THEN_DOWN = 1;
    
    public const uint PPCAPS_SQUARE_SCALING = 1;
    
    public const uint PR_JOBSTATUS = 0;
    
    public static readonly Guid PRINT_APP_BIDI_NOTIFY_CHANNEL = new("2abad223-b994-4aca-82fc-4571b1b585ac");
    
    public static readonly Guid PRINT_PORT_MONITOR_NOTIFY_CHANNEL = new("25df3b0e-74a9-47f5-80ce-79b4b1eb5c58");
    
    public const uint PRINTER_ATTRIBUTE_DEFAULT = 4;
    
    public const uint PRINTER_ATTRIBUTE_DIRECT = 2;
    
    public const uint PRINTER_ATTRIBUTE_DO_COMPLETE_FIRST = 512;
    
    public const uint PRINTER_ATTRIBUTE_ENABLE_BIDI = 2048;
    
    public const uint PRINTER_ATTRIBUTE_ENABLE_DEVQ = 128;
    
    public const uint PRINTER_ATTRIBUTE_ENTERPRISE_CLOUD = 8388608;
    
    public const uint PRINTER_ATTRIBUTE_FAX = 16384;
    
    public const uint PRINTER_ATTRIBUTE_FRIENDLY_NAME = 1048576;
    
    public const uint PRINTER_ATTRIBUTE_HIDDEN = 32;
    
    public const uint PRINTER_ATTRIBUTE_KEEPPRINTEDJOBS = 256;
    
    public const uint PRINTER_ATTRIBUTE_LOCAL = 64;
    
    public const uint PRINTER_ATTRIBUTE_MACHINE = 524288;
    
    public const uint PRINTER_ATTRIBUTE_NETWORK = 16;
    
    public const uint PRINTER_ATTRIBUTE_PER_USER = 4194304;
    
    public const uint PRINTER_ATTRIBUTE_PUBLISHED = 8192;
    
    public const uint PRINTER_ATTRIBUTE_PUSHED_MACHINE = 262144;
    
    public const uint PRINTER_ATTRIBUTE_PUSHED_USER = 131072;
    
    public const uint PRINTER_ATTRIBUTE_QUEUED = 1;
    
    public const uint PRINTER_ATTRIBUTE_RAW_ONLY = 4096;
    
    public const uint PRINTER_ATTRIBUTE_SHARED = 8;
    
    public const uint PRINTER_ATTRIBUTE_TS = 32768;
    
    public const uint PRINTER_ATTRIBUTE_TS_GENERIC_DRIVER = 2097152;
    
    public const uint PRINTER_ATTRIBUTE_WORK_OFFLINE = 1024;
    
    public const uint PRINTER_CHANGE_ADD_FORM = 65536;
    
    public const uint PRINTER_CHANGE_ADD_JOB = 256;
    
    public const uint PRINTER_CHANGE_ADD_PORT = 1048576;
    
    public const uint PRINTER_CHANGE_ADD_PRINT_PROCESSOR = 16777216;
    
    public const uint PRINTER_CHANGE_ADD_PRINTER = 1;
    
    public const uint PRINTER_CHANGE_ADD_PRINTER_DRIVER = 268435456;
    
    public const uint PRINTER_CHANGE_ALL = 2138570751;
    
    public const uint PRINTER_CHANGE_CONFIGURE_PORT = 2097152;
    
    public const uint PRINTER_CHANGE_DELETE_FORM = 262144;
    
    public const uint PRINTER_CHANGE_DELETE_JOB = 1024;
    
    public const uint PRINTER_CHANGE_DELETE_PORT = 4194304;
    
    public const uint PRINTER_CHANGE_DELETE_PRINT_PROCESSOR = 67108864;
    
    public const uint PRINTER_CHANGE_DELETE_PRINTER = 4;
    
    public const uint PRINTER_CHANGE_DELETE_PRINTER_DRIVER = 1073741824;
    
    public const uint PRINTER_CHANGE_FAILED_CONNECTION_PRINTER = 8;
    
    public const uint PRINTER_CHANGE_FORM = 458752;
    
    public const uint PRINTER_CHANGE_JOB = 65280;
    
    public const uint PRINTER_CHANGE_PORT = 7340032;
    
    public const uint PRINTER_CHANGE_PRINT_PROCESSOR = 117440512;
    
    public const uint PRINTER_CHANGE_PRINTER = 255;
    
    public const uint PRINTER_CHANGE_PRINTER_DRIVER = 1879048192;
    
    public const uint PRINTER_CHANGE_SERVER = 134217728;
    
    public const uint PRINTER_CHANGE_SET_FORM = 131072;
    
    public const uint PRINTER_CHANGE_SET_JOB = 512;
    
    public const uint PRINTER_CHANGE_SET_PRINTER = 2;
    
    public const uint PRINTER_CHANGE_SET_PRINTER_DRIVER = 536870912;
    
    public const uint PRINTER_CHANGE_TIMEOUT = 2147483648;
    
    public const uint PRINTER_CHANGE_WRITE_JOB = 2048;
    
    public const uint PRINTER_CONNECTION_MISMATCH = 32;
    
    public const uint PRINTER_CONNECTION_NO_UI = 64;
    ...
    public const uint PRINTER_DRIVER_CATEGORY_3D = 4096;
    
    public const uint PRINTER_DRIVER_CATEGORY_CLOUD = 8192;
    
    public const uint PRINTER_DRIVER_CATEGORY_FAX = 64;
    
    public const uint PRINTER_DRIVER_CATEGORY_FILE = 128;
    
    public const uint PRINTER_DRIVER_CATEGORY_SERVICE = 512;
    
    public const uint PRINTER_DRIVER_CATEGORY_VIRTUAL = 256;
    
    public const uint PRINTER_DRIVER_CLASS = 8;
    
    public const uint PRINTER_DRIVER_DERIVED = 16;
    
    public const uint PRINTER_DRIVER_NOT_SHAREABLE = 32;
    
    public const uint PRINTER_DRIVER_PACKAGE_AWARE = 1;
    
    public const uint PRINTER_DRIVER_SANDBOX_DISABLED = 2048;
    
    public const uint PRINTER_DRIVER_SANDBOX_ENABLED = 4;
    
    public const uint PRINTER_DRIVER_SOFT_RESET_REQUIRED = 1024;
    
    public const uint PRINTER_DRIVER_XPS = 2;
    
    public const uint PRINTER_ENUM_CATEGORY_3D = 67108864;
    
    public const uint PRINTER_ENUM_CATEGORY_ALL = 33554432;
    
    public const uint PRINTER_ENUM_CONNECTIONS = 4;
    
    public const uint PRINTER_ENUM_CONTAINER = 32768;
    
    public const uint PRINTER_ENUM_DEFAULT = 1;
    
    public const uint PRINTER_ENUM_EXPAND = 16384;
    
    public const uint PRINTER_ENUM_FAVORITE = 4;
    
    public const uint PRINTER_ENUM_HIDE = 16777216;
    
    public const uint PRINTER_ENUM_ICON1 = 65536;
    
    public const uint PRINTER_ENUM_ICON2 = 131072;
    
    public const uint PRINTER_ENUM_ICON3 = 262144;
    
    public const uint PRINTER_ENUM_ICON4 = 524288;
    
    public const uint PRINTER_ENUM_ICON5 = 1048576;
    
    public const uint PRINTER_ENUM_ICON6 = 2097152;
    
    public const uint PRINTER_ENUM_ICON7 = 4194304;
    
    public const uint PRINTER_ENUM_ICON8 = 8388608;
    
    public const uint PRINTER_ENUM_ICONMASK = 16711680;
    
    public const uint PRINTER_ENUM_LOCAL = 2;
    
    public const uint PRINTER_ENUM_NAME = 8;
    
    public const uint PRINTER_ENUM_NETWORK = 64;
    
    public const uint PRINTER_ENUM_REMOTE = 16;
    
    public const uint PRINTER_ENUM_SHARED = 32;
    
    public const uint PRINTER_ERROR_INFORMATION = 2147483648;
    
    public const uint PRINTER_ERROR_JAM = 2;
    
    public const uint PRINTER_ERROR_OUTOFPAPER = 1;
    
    public const uint PRINTER_ERROR_OUTOFTONER = 4;
    
    public const uint PRINTER_ERROR_SEVERE = 536870912;
    
    public const uint PRINTER_ERROR_WARNING = 1073741824;
    ...
    public const uint PRINTER_EVENT_FLAG_NO_UI = 1;
    
    public const uint PRINTER_EVENT_INITIALIZE = 3;
    
    public static readonly Guid PRINTER_EXTENSION_DETAILEDREASON_PRINTER_STATUS = new("5d5a1704-dfd1-4181-8eee-815c86edad31");
    
    public static readonly Guid PRINTER_EXTENSION_REASON_DRIVER_EVENT = new("23bb1328-63de-4293-915b-a6a23d929acb");
    
    public static readonly Guid PRINTER_EXTENSION_REASON_PRINT_PREFERENCES = new("ec8f261f-267c-469f-b5d6-3933023c29cc");
    
    public const uint PRINTER_NOTIFY_CATEGORY_3D = 8192;
    
    public const uint PRINTER_NOTIFY_CATEGORY_ALL = 4096;
    
    public const uint PRINTER_NOTIFY_FIELD_ATTRIBUTES = 13;
    
    public const uint PRINTER_NOTIFY_FIELD_AVERAGE_PPM = 21;
    
    public const uint PRINTER_NOTIFY_FIELD_BRANCH_OFFICE_PRINTING = 28;
    
    public const uint PRINTER_NOTIFY_FIELD_BYTES_PRINTED = 25;
    
    public const uint PRINTER_NOTIFY_FIELD_CJOBS = 20;
    
    public const uint PRINTER_NOTIFY_FIELD_COMMENT = 5;
    
    public const uint PRINTER_NOTIFY_FIELD_DATATYPE = 11;
    
    public const uint PRINTER_NOTIFY_FIELD_DEFAULT_PRIORITY = 15;
    
    public const uint PRINTER_NOTIFY_FIELD_DEVMODE = 7;
    
    public const uint PRINTER_NOTIFY_FIELD_DRIVER_NAME = 4;
    
    public const uint PRINTER_NOTIFY_FIELD_FRIENDLY_NAME = 27;
    
    public const uint PRINTER_NOTIFY_FIELD_LOCATION = 6;
    
    public const uint PRINTER_NOTIFY_FIELD_OBJECT_GUID = 26;
    
    public const uint PRINTER_NOTIFY_FIELD_PAGES_PRINTED = 23;
    
    public const uint PRINTER_NOTIFY_FIELD_PARAMETERS = 10;
    
    public const uint PRINTER_NOTIFY_FIELD_PORT_NAME = 3;
    
    public const uint PRINTER_NOTIFY_FIELD_PRINT_PROCESSOR = 9;
    
    public const uint PRINTER_NOTIFY_FIELD_PRINTER_NAME = 1;
    
    public const uint PRINTER_NOTIFY_FIELD_PRIORITY = 14;
    
    public const uint PRINTER_NOTIFY_FIELD_SECURITY_DESCRIPTOR = 12;
    
    public const uint PRINTER_NOTIFY_FIELD_SEPFILE = 8;
    
    public const uint PRINTER_NOTIFY_FIELD_SERVER_NAME = 0;
    
    public const uint PRINTER_NOTIFY_FIELD_SHARE_NAME = 2;
    
    public const uint PRINTER_NOTIFY_FIELD_START_TIME = 16;
    
    public const uint PRINTER_NOTIFY_FIELD_STATUS = 18;
    
    public const uint PRINTER_NOTIFY_FIELD_STATUS_STRING = 19;
    
    public const uint PRINTER_NOTIFY_FIELD_TOTAL_BYTES = 24;
    
    public const uint PRINTER_NOTIFY_FIELD_TOTAL_PAGES = 22;
    
    public const uint PRINTER_NOTIFY_FIELD_UNTIL_TIME = 17;
    
    public const uint PRINTER_NOTIFY_INFO_DATA_COMPACT = 1;
    
    public const uint PRINTER_NOTIFY_INFO_DISCARDED = 1;
    
    public const uint PRINTER_NOTIFY_OPTIONS_REFRESH = 1;
    ...
    public const uint PRINTER_NOTIFY_TYPE = 0;
    
    public const uint PRINTER_OEMINTF_VERSION = 65536;
    
    public const uint PRINTER_STATUS_BUSY = 512;
    
    public const uint PRINTER_STATUS_DOOR_OPEN = 4194304;
    
    public const uint PRINTER_STATUS_DRIVER_UPDATE_NEEDED = 67108864;
    
    public const uint PRINTER_STATUS_ERROR = 2;
    
    public const uint PRINTER_STATUS_INITIALIZING = 32768;
    
    public const uint PRINTER_STATUS_IO_ACTIVE = 256;
    
    public const uint PRINTER_STATUS_MANUAL_FEED = 32;
    
    public const uint PRINTER_STATUS_NO_TONER = 262144;
    
    public const uint PRINTER_STATUS_NOT_AVAILABLE = 4096;
    
    public const uint PRINTER_STATUS_OFFLINE = 128;
    
    public const uint PRINTER_STATUS_OUT_OF_MEMORY = 2097152;
    
    public const uint PRINTER_STATUS_OUTPUT_BIN_FULL = 2048;
    
    public const uint PRINTER_STATUS_PAGE_PUNT = 524288;
    
    public const uint PRINTER_STATUS_PAPER_JAM = 8;
    
    public const uint PRINTER_STATUS_PAPER_OUT = 16;
    
    public const uint PRINTER_STATUS_PAPER_PROBLEM = 64;
    
    public const uint PRINTER_STATUS_PAUSED = 1;
    
    public const uint PRINTER_STATUS_PENDING_DELETION = 4;
    
    public const uint PRINTER_STATUS_POWER_SAVE = 16777216;
    
    public const uint PRINTER_STATUS_PRINTING = 1024;
    
    public const uint PRINTER_STATUS_PROCESSING = 16384;
    
    public const uint PRINTER_STATUS_SERVER_OFFLINE = 33554432;
    
    public const uint PRINTER_STATUS_SERVER_UNKNOWN = 8388608;
    
    public const uint PRINTER_STATUS_TONER_LOW = 131072;
    
    public const uint PRINTER_STATUS_USER_INTERVENTION = 1048576;
    
    public const uint PRINTER_STATUS_WAITING = 8192;
    
    public const uint PRINTER_STATUS_WARMING_UP = 65536;
    ...
    public const uint PRINTTICKET_ISTREAM_APIS = 1;
    ...
    public const uint PROPSHEETUI_INFO_VERSION = 256;
    ...
    public const uint PROTOCOL_LPR_TYPE = 2;
    
    public const uint PROTOCOL_RAWTCP_TYPE = 1;
    
    public const uint PROTOCOL_UNKNOWN_TYPE = 0;
    
    public const uint PSIDENT_GDICENTRIC = 0;
    
    public const uint PSIDENT_PSCENTRIC = 1;
    
    public const uint PSINJECT_DLFONT = 3722304989;
    ...
    public const uint PSUIHDRF_DEFTITLE = 16;
    
    public const uint PSUIHDRF_EXACT_PTITLE = 32;
    
    public const uint PSUIHDRF_NOAPPLYNOW = 2;
    
    public const uint PSUIHDRF_OBSOLETE = 1;
    
    public const uint PSUIHDRF_PROPTITLE = 4;
    
    public const uint PSUIHDRF_USEHICON = 8;
    
    public const uint PSUIINFO_UNICODE = 1;
    ...
    public const uint PT_BEZIERTO = 4;
    
    public const uint PT_CLOSEFIGURE = 1;
    
    public const uint PT_LINETO = 2;
    
    public const uint PT_MOVETO = 6;
    ...
    public const uint QCP_DEVICEPROFILE = 0;
    
    public const uint QCP_PROFILEDISK = 2;
    
    public const uint QCP_PROFILEMEMORY = 1;
    
    public const uint QCP_SOURCEPROFILE = 1;
    ...
    public const uint QUERYROPSUPPORT = 40;
    
    public const uint RASTER_FONTTYPE = 1;
    
    public const uint RAWTCP = 1;
    
    public const uint RC_BANDING = 2;
    
    public const uint RC_BIGFONT = 1024;
    
    public const uint RC_BITBLT = 1;
    
    public const uint RC_BITMAP64 = 8;
    
    public const uint RC_DEVBITS = 32768;
    
    public const uint RC_DI_BITMAP = 128;
    
    public const uint RC_DIBTODEV = 512;
    
    public const uint RC_FLOODFILL = 4096;
    
    public const uint RC_GDI20_OUTPUT = 16;
    
    public const uint RC_GDI20_STATE = 32;
    
    public const uint RC_OP_DX_OUTPUT = 16384;
    
    public const uint RC_PALETTE = 256;
    
    public const uint RC_SAVEBITMAP = 64;
    
    public const uint RC_SCALING = 4;
    
    public const uint RC_STRETCHBLT = 2048;
    
    public const uint RC_STRETCHDIB = 8192;
    ...
    public const uint REVERSE_PAGES_FOR_REVERSE_DUPLEX = 1;
    
    public const uint REVERSE_PRINT = 1;
    
    public const uint RIGHT_THEN_DOWN = 1;
    ...
    public const uint S_PT_CONFLICT_RESOLVED = 262146;
    
    public const uint S_PT_NO_CONFLICT = 262145;
    
    public const uint SAVE_CTM = 4101;
    
    public const uint SB_CONST_ALPHA = 1;
    
    public const uint SB_GRAD_RECT = 16;
    
    public const uint SB_GRAD_TRI = 32;
    
    public const uint SB_NONE = 0;
    
    public const uint SB_PIXEL_ALPHA = 2;
    
    public const uint SB_PREMULT_ALPHA = 4;
    
    public const uint SC_SCREENSAVE = 61760;
    
    public const uint SELECTDIB = 41;
    
    public const uint SELECTPAPERSOURCE = 18;
    
    public const uint SERVER_NOTIFY_FIELD_PRINT_DRIVER_ISOLATION_GROUP = 0;
    
    public const uint SERVER_NOTIFY_TYPE = 2;
    ...
    public const uint SETICMPROFILE_EMBEDED = 1;
    ...
    public const uint SETOPTIONS_FLAG_KEEP_CONFLICT = 2;
    
    public const uint SETOPTIONS_FLAG_RESOLVE_CONFLICT = 1;
    ...
    public const uint SP_NOTREPORTED = 16384;
    ...
    public const uint SPLCLIENT_INFO_INTERNAL_LEVEL = 100;
    ...
    public const uint SPOOL_FILE_PERSISTENT = 1;
    
    public const uint SPOOL_FILE_TEMPORARY = 2;
    ...
    public const uint STRING_LANGPAIR = 4;
    
    public const uint STRING_MUIDLL = 2;
    
    public const uint STRING_NONE = 1;
    ...
    public const uint TC_CP_STROKE = 4;
    
    public const uint TC_CR_90 = 8;
    
    public const uint TC_CR_ANY = 16;
    
    public const uint TC_EA_DOUBLE = 512;
    
    public const uint TC_IA_ABLE = 1024;
    
    public const uint TC_OP_CHARACTER = 1;
    
    public const uint TC_OP_STROKE = 2;
    
    public const uint TC_RA_ABLE = 8192;
    
    public const uint TC_RESERVED = 32768;
    
    public const uint TC_SA_CONTIN = 256;
    
    public const uint TC_SA_DOUBLE = 64;
    
    public const uint TC_SA_INTEGER = 128;
    
    public const uint TC_SCROLLBLT = 65536;
    
    public const uint TC_SF_X_YINDEP = 32;
    
    public const uint TC_SO_ABLE = 4096;
    
    public const uint TC_UA_ABLE = 2048;
    
    public const uint TC_VA_ABLE = 16384;
    
    public static readonly Guid TintEffectGuid = new("1077af00-2848-4441-9489-44ad4c2d7a2c");
    
    public const uint TRANSFORM_CTM = 4107;
    
    public const uint TRUETYPE_FONTTYPE = 4;
    
    public const uint TT_AVAILABLE = 1;
    
    public const uint TT_ENABLED = 2;
    ...
    public const uint TTDELETE_DONTREMOVEFONT = 1;
    ...
    public const uint TTEMBED_EUDCEMBEDDED = 2;
    
    public const uint TTEMBED_FAILIFVARIATIONSIMULATED = 16;
    
    public const uint TTEMBED_SUBSETCANCEL = 4;
    
    public const uint TTEMBED_VARIATIONSIMULATED = 1;
    
    public const uint TTEMBED_WEBOBJECT = 128;
    
    public const uint TTEMBED_XORENCRYPTDATA = 268435456;
    
    public const uint TTFCFP_APPLE_PLATFORMID = 1;
    
    public const uint TTFCFP_DELTA = 2;
    
    public const uint TTFCFP_DONT_CARE = 65535;
    
    public const uint TTFCFP_FLAGS_COMPRESS = 2;
    
    public const uint TTFCFP_FLAGS_GLYPHLIST = 8;
    
    public const uint TTFCFP_FLAGS_SUBSET = 1;
    
    public const uint TTFCFP_FLAGS_TTC = 4;
    ...
    public const uint TTLOAD_EUDC_OVERWRITE = 2;
    
    public const uint TTLOAD_EUDC_SET = 4;
    
    public const uint TTLOAD_PRIVATE = 1;
    ...
    public const uint UFF_VERSION_NUMBER = 65537;
    
    public const uint UFM_CART = 2;
    
    public const uint UFM_SCALABLE = 4;
    
    public const uint UFM_SOFT = 1;
    ...
    public const uint UFOFLAG_TTDOWNLOAD_BITMAP = 2;
    
    public const uint UFOFLAG_TTDOWNLOAD_TTOUTLINE = 4;
    
    public const uint UFOFLAG_TTFONT = 1;
    
    public const uint UFOFLAG_TTOUTLINE_BOLD_SIM = 8;
    
    public const uint UFOFLAG_TTOUTLINE_ITALIC_SIM = 16;
    
    public const uint UFOFLAG_TTOUTLINE_VERTICAL = 32;
    
    public const uint UFOFLAG_TTSUBSTITUTED = 64;
    
    public const uint UNI_GLYPHSETDATA_VERSION_1_0 = 65536;
    
    public const uint UNIFM_VERSION_1_0 = 65536;
    
    public const uint UNKNOWN_PROTOCOL = 0;
    
    public const uint UPDP_CHECK_DRIVERSTORE = 4;
    
    public const uint UPDP_SILENT_UPLOAD = 1;
    
    public const uint UPDP_UPLOAD_ALWAYS = 2;
    ...
    public const uint USBPRINT_IOCTL_INDEX = 0;
    ...
    public const uint WGL_SWAP_MAIN_PLANE = 1;
    
    public const uint WGL_SWAP_OVERLAY1 = 2;
    
    public const uint WGL_SWAP_OVERLAY10 = 1024;
    
    public const uint WGL_SWAP_OVERLAY11 = 2048;
    
    public const uint WGL_SWAP_OVERLAY12 = 4096;
    
    public const uint WGL_SWAP_OVERLAY13 = 8192;
    
    public const uint WGL_SWAP_OVERLAY14 = 16384;
    
    public const uint WGL_SWAP_OVERLAY15 = 32768;
    
    public const uint WGL_SWAP_OVERLAY2 = 4;
    
    public const uint WGL_SWAP_OVERLAY3 = 8;
    
    public const uint WGL_SWAP_OVERLAY4 = 16;
    
    public const uint WGL_SWAP_OVERLAY5 = 32;
    
    public const uint WGL_SWAP_OVERLAY6 = 64;
    
    public const uint WGL_SWAP_OVERLAY7 = 128;
    
    public const uint WGL_SWAP_OVERLAY8 = 256;
    
    public const uint WGL_SWAP_OVERLAY9 = 512;
    
    public const uint WGL_SWAP_UNDERLAY1 = 65536;
    
    public const uint WGL_SWAP_UNDERLAY10 = 33554432;
    
    public const uint WGL_SWAP_UNDERLAY11 = 67108864;
    
    public const uint WGL_SWAP_UNDERLAY12 = 134217728;
    
    public const uint WGL_SWAP_UNDERLAY13 = 268435456;
    
    public const uint WGL_SWAP_UNDERLAY14 = 536870912;
    
    public const uint WGL_SWAP_UNDERLAY15 = 1073741824;
    
    public const uint WGL_SWAP_UNDERLAY2 = 131072;
    
    public const uint WGL_SWAP_UNDERLAY3 = 262144;
    
    public const uint WGL_SWAP_UNDERLAY4 = 524288;
    
    public const uint WGL_SWAP_UNDERLAY5 = 1048576;
    
    public const uint WGL_SWAP_UNDERLAY6 = 2097152;
    
    public const uint WGL_SWAP_UNDERLAY7 = 4194304;
    
    public const uint WGL_SWAP_UNDERLAY8 = 8388608;
    
    public const uint WGL_SWAP_UNDERLAY9 = 16777216;
