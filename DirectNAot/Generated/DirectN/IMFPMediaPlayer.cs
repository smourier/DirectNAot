...
public partial interface IMFPMediaPlayer
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateMediaItemFromURL(PWSTR pwszURL, [MarshalAs(UnmanagedType.U4)] bool fSync, nuint dwUserData, nint/* nint */ ppMediaItem);
    
    // https://learn.microsoft.com/windows/win32/api/mfplay/nf-mfplay-imfpmediaplayer-createmediaitemfromobject
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateMediaItemFromObject(nint pIUnknownObj, [MarshalAs(UnmanagedType.U4)] bool fSync, nuint dwUserData, nint/* nint */ ppMediaItem);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetNativeVideoSize(nint/* nint */ pszVideo, nint/* nint */ pszARVideo);
    
    // https://learn.microsoft.com/windows/win32/api/mfplay/nf-mfplay-imfpmediaplayer-getidealvideosize
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetIdealVideoSize(nint/* nint */ pszMin, nint/* nint */ pszMax);
