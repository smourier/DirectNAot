...
public partial interface ID3D11ShaderTrace
{
    ...
    public HRESULT TraceReady(nint/* nint */ pTestCount);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetTraceStats(out D3D11_TRACE_STATS pTraceStats);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetInitialRegisterContents(in D3D11_TRACE_REGISTER pRegister, out D3D11_TRACE_VALUE pValue);
    
    // https://learn.microsoft.com/windows/win32/api/d3d11shadertracing/nf-d3d11shadertracing-id3d11shadertrace-getstep
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetStep(uint stepIndex, out D3D11_TRACE_STEP pTraceStep);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetWrittenRegister(uint stepIndex, uint writtenRegisterIndex, out D3D11_TRACE_REGISTER pRegister, out D3D11_TRACE_VALUE pValue);
    
    // https://learn.microsoft.com/windows/win32/api/d3d11shadertracing/nf-d3d11shadertracing-id3d11shadertrace-getreadregister
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetReadRegister(uint stepIndex, uint readRegisterIndex, out D3D11_TRACE_REGISTER pRegister, out D3D11_TRACE_VALUE pValue);
}
