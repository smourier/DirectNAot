...
public partial interface ID3D11Device
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateInputLayout(in D3D11_INPUT_ELEMENT_DESC pInputElementDescs, uint NumElements, nint pShaderBytecodeWithInputSignature, nuint BytecodeLength, nint /* optional ID3D11InputLayout */ ppInputLayout);
