...
public partial interface ID2D1Ink : ID2D1Resource
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT StreamAsGeometry(ID2D1InkStyle inkStyle, nint/* nint */ worldTransform, float flatteningTolerance, ID2D1SimplifiedGeometrySink geometrySink);
    
    // https://learn.microsoft.com/windows/win32/api/d2d1_3/nf-d2d1_3-id2d1ink-getbounds
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetBounds(ID2D1InkStyle inkStyle, nint/* nint */ worldTransform, out D2D_RECT_F bounds);
}
