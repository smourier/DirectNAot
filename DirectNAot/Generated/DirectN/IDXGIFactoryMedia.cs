...
public partial interface IDXGIFactoryMedia
{
    ...
    public HRESULT CreateSwapChainForCompositionSurfaceHandle(nint pDevice, HANDLE hSurface, in DXGI_SWAP_CHAIN_DESC1 pDesc, IDXGIOutput pRestrictToOutput, out IDXGISwapChain1 ppSwapChain);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT CreateDecodeSwapChainForCompositionSurfaceHandle(nint pDevice, HANDLE hSurface, in DXGI_DECODE_SWAP_CHAIN_DESC pDesc, IDXGIResource pYuvDecodeBuffers, IDXGIOutput pRestrictToOutput, out IDXGIDecodeSwapChain ppSwapChain);
}
