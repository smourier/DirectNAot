...
public partial interface ID3D12VideoEncoderHeap : ID3D12Pageable
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetResolutionList(uint ResolutionsListCount, [In][Out][MarshalUsing(CountElementName = nameof(ResolutionsListCount))] D3D12_VIDEO_ENCODER_PICTURE_RESOLUTION_DESC[] pResolutionList);
}
