...
public partial interface ICompositorInterop
{
    ...
    HRESULT CreateCompositionSurfaceForHandle(HANDLE swapChain, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<object>))] out object /* object */ result);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateCompositionSurfaceForSwapChain(nint swapChain, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<object>))] out object /* object */ result);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateGraphicsDevice(nint renderingDevice, [MarshalUsing(typeof(UniqueComInterfaceMarshaller<object>))] out object /* object */ result);
}
