...
public partial interface IMFSourceResolver
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT BeginCreateObjectFromURL(PWSTR pwszURL, uint dwFlags, IPropertyStore pProps, nint/* nint */ ppIUnknownCancelCookie, IMFAsyncCallback pCallback, nint punkState);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT BeginCreateObjectFromByteStream(IMFByteStream pByteStream, PWSTR pwszURL, uint dwFlags, IPropertyStore pProps, nint/* nint */ ppIUnknownCancelCookie, IMFAsyncCallback pCallback, nint punkState);
