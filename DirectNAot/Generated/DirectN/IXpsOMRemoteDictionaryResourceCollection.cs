...
public partial interface IXpsOMRemoteDictionaryResourceCollection
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetAt(uint index, out IXpsOMRemoteDictionaryResource @object);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT InsertAt(uint index, IXpsOMRemoteDictionaryResource @object);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT SetAt(uint index, IXpsOMRemoteDictionaryResource @object);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT Append(IXpsOMRemoteDictionaryResource @object);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetByPartName(IOpcPartUri partName, out IXpsOMRemoteDictionaryResource remoteDictionaryResource);
}
