...
public partial interface IDXGIDevice4 : IDXGIDevice3
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT ReclaimResources1(uint NumResources, [MarshalUsing(CountElementName = nameof(NumResources))] in IDXGIResource[] ppResources, [In][Out][MarshalUsing(CountElementName = nameof(NumResources))] DXGI_RECLAIM_RESOURCE_RESULTS[] pResults);
}
