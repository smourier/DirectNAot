...
public partial interface IMFSensorActivityReport
{
    ...
    HRESULT GetFriendlyName(out PWSTR FriendlyName, uint cchFriendlyName, out uint pcchWritten);
    
    // https://learn.microsoft.com/windows/win32/api/mfidl/nf-mfidl-imfsensoractivityreport-getsymboliclink
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetSymbolicLink(out PWSTR SymbolicLink, uint cchSymbolicLink, out uint pcchWritten);
