...
public partial interface IDirectDrawSurface
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT Blt(ref FoundationRECT param0, IDirectDrawSurface param1, ref FoundationRECT param2, uint param3, ref DDBLTFX param4);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT BltFast(uint param0, uint param1, IDirectDrawSurface param2, ref FoundationRECT param3, uint param4);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT UpdateOverlay(ref FoundationRECT param0, IDirectDrawSurface param1, ref FoundationRECT param2, uint param3, ref DDOVERLAYFX param4);
