...
public partial interface ID3D11On12Device
{
    ...
    HRESULT CreateWrappedResource(nint pResource12, in D3D11_RESOURCE_FLAGS pFlags11, D3D12_RESOURCE_STATES InState, D3D12_RESOURCE_STATES OutState, in Guid riid, nint/* nint */ ppResource11);
    
    // https://learn.microsoft.com/windows/win32/api/d3d11on12/nf-d3d11on12-id3d11on12device-releasewrappedresources
    [PreserveSig]
    void ReleaseWrappedResources(in ID3D11Resource ppResources, uint NumResources);
    
    // https://learn.microsoft.com/windows/win32/api/d3d11on12/nf-d3d11on12-id3d11on12device-acquirewrappedresources
    [PreserveSig]
    void AcquireWrappedResources(in ID3D11Resource ppResources, uint NumResources);
}
