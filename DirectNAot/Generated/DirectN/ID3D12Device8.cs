...
public partial interface ID3D12Device8 : ID3D12Device7
{
    ...
    [PreserveSig]
    public D3D12_RESOURCE_ALLOCATION_INFO GetResourceAllocationInfo2(uint visibleMask, uint numResourceDescs, in D3D12_RESOURCE_DESC1 pResourceDescs, nint/* nint */ pResourceAllocationInfo1);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT CreatePlacedResource1(ID3D12Heap pHeap, ulong HeapOffset, in D3D12_RESOURCE_DESC1 pDesc, D3D12_RESOURCE_STATES InitialState, nint/* nint */ pOptimizedClearValue, in Guid riid, nint/* nint */ ppvResource);
    ...
    [PreserveSig]
    public void GetCopyableFootprints1(in D3D12_RESOURCE_DESC1 pResourceDesc, uint FirstSubresource, uint NumSubresources, ulong BaseOffset, nint/* nint */ pLayouts, nint/* nint */ pNumRows, nint/* nint */ pRowSizeInBytes, nint/* nint */ pTotalBytes);
}
