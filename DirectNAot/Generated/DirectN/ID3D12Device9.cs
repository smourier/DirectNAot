...
public partial interface ID3D12Device9 : ID3D12Device8
{
    ...
    public HRESULT CreateShaderCacheSession(in D3D12_SHADER_CACHE_SESSION_DESC pDesc, in Guid riid, nint/* nint */ ppvSession);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT CreateCommandQueue1(in D3D12_COMMAND_QUEUE_DESC pDesc, in Guid CreatorID, in Guid riid, out nint ppCommandQueue);
}
