...
public partial interface IAudioSessionManager
{
    ...
    HRESULT GetAudioSessionControl(nint/* nint */ AudioSessionGuid, uint StreamFlags, out IAudioSessionControl SessionControl);
    
    // https://learn.microsoft.com/windows/win32/api/audiopolicy/nf-audiopolicy-iaudiosessionmanager-getsimpleaudiovolume
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetSimpleAudioVolume(nint/* nint */ AudioSessionGuid, uint StreamFlags, out ISimpleAudioVolume AudioVolume);
}
