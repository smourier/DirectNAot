...
public partial interface IStorage
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT OpenStream(PWSTR pwcsName, nint/* nint */ reserved1, STGM grfMode, uint reserved2, out IStream ppstm);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CopyTo(uint ciidExclude, nint/* nint */ rgiidExclude, nint/* nint */ snbExclude, IStorage pstgDest);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT EnumElements(uint reserved1, nint/* nint */ reserved2, uint reserved3, out IEnumSTATSTG ppenum);
