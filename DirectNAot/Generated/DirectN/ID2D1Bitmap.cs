...
public partial interface ID2D1Bitmap : ID2D1Image
{
    ...
    HRESULT CopyFromBitmap(nint/* nint */ destPoint, ID2D1Bitmap bitmap, nint/* nint */ srcRect);
    
    // https://learn.microsoft.com/windows/win32/api/d2d1/nf-d2d1-id2d1bitmap-copyfromrendertarget
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CopyFromRenderTarget(nint/* nint */ destPoint, ID2D1RenderTarget renderTarget, nint/* nint */ srcRect);
    
    // https://learn.microsoft.com/windows/win32/api/d2d1/nf-d2d1-id2d1bitmap-copyfrommemory
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CopyFromMemory(nint/* nint */ dstRect, nint srcData, uint pitch);
}
