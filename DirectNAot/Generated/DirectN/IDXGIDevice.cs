...
public partial interface IDXGIDevice : IDXGIObject
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT CreateSurface(in DXGI_SURFACE_DESC pDesc, uint NumSurfaces, DXGI_USAGE Usage, nint /* optional DXGI_SHARED_RESOURCE */ pSharedResource, out IDXGISurface ppSurface);
    
    // https://learn.microsoft.com/windows/win32/api/dxgi/nf-dxgi-idxgidevice-queryresourceresidency
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT QueryResourceResidency(nint ppResources, out DXGI_RESIDENCY pResidencyStatus, uint NumResources);
