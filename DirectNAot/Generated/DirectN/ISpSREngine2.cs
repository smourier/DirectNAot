...
public partial interface ISpSREngine2 : ISpSREngine
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT SetAdaptationData2(nint pvEngineContext, PWSTR pAdaptationData, uint cch, PWSTR pTopicName, SPADAPTATIONSETTINGS eSettings, SPADAPTATIONRELEVANCE eRelevance);
