...
public partial interface IDWriteFontFamily2 : IDWriteFontFamily1
{
    ...
    HRESULT GetMatchingFonts([MarshalUsing(CountElementName = nameof(fontAxisValueCount))] in DWRITE_FONT_AXIS_VALUE[] fontAxisValues, uint fontAxisValueCount, out IDWriteFontList2 matchingFonts);
