...
public partial interface IDirectManipulationPrimaryContent
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT SetSnapPoints(DIRECTMANIPULATION_MOTION_TYPES motion, nint/* nint */ points, uint pointCount);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetInertiaEndTransform(out float matrix, uint pointCount);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT GetCenterPoint(out float centerX, out float centerY);
}
