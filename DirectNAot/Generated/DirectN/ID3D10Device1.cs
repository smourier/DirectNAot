...
public partial interface ID3D10Device1 : ID3D10Device
{
    ...
    public HRESULT CreateShaderResourceView1(ID3D10Resource pResource, nint/* nint */ pDesc, nint/* nint */ ppSRView);
    
    // https://learn.microsoft.com/windows/win32/api/d3d10_1/nf-d3d10_1-id3d10device1-createblendstate1
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    public HRESULT CreateBlendState1(in D3D10_BLEND_DESC1 pBlendStateDesc, nint/* nint */ ppBlendState);
