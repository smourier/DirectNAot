...
public partial interface IDirectXVideoDecoder
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetCreationParameters(nint/* nint */ pDeviceGuid, nint/* nint */ pVideoDesc, nint/* nint */ pConfig, out IDirect3DSurface9 pDecoderRenderTargets, nint/* nint */ pNumSurfaces);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT BeginFrame(IDirect3DSurface9 pRenderTarget, nint/* nint */ pvPVPData);
    
    // https://learn.microsoft.com/windows/win32/api/dxva2api/nf-dxva2api-idirectxvideodecoder-endframe
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT EndFrame(nint/* nint */ pHandleComplete);
