...
public partial interface IMFMediaEngine
{
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT TransferVideoFrame(nint pDstSurf, nint/* nint */ pSrc, FoundationRECT pDst, nint/* nint */ pBorderClr);
