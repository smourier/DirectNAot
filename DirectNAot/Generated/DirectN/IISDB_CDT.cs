...
public partial interface IISDB_CDT
{
    ...
    HRESULT Initialize(ISectionList pSectionList, IMpeg2Data pMPEGData, byte bSectionNumber);
    ...
    [PreserveSig]
    [return: MarshalAs(UnmanagedType.Error)]
    HRESULT GetTableDescriptorByTag(byte bTag, nint/* nint */ pdwCookie, out IGenericDescriptor ppDescriptor);
