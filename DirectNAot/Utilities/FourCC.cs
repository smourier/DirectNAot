...
public struct FourCC : IEquatable<FourCC>, IFormattable
{
    ...
    public readonly bool Equals(FourCC other) => _value == other._value;
    ...
    public readonly Guid ToGuid() => new(ToString("I", null) + "-" + Postfix);
    ...
    public override readonly string ToString() => string.Format("{0}", new string(new[]
    {
        (char) (_value & 0xFF),
        (char) ((_value >> 8) & 0xFF),
        (char) ((_value >> 16) & 0xFF),
    ...
    public static implicit operator FourCC(uint fcc) => new(fcc);
    public static implicit operator FourCC(int fcc) => new(fcc);
    public static implicit operator string(FourCC fcc) => fcc.ToString();
    public static implicit operator FourCC(string fcc) => new(fcc);
}
