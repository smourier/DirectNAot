...
public static class D2D1Functions
{
    ...
    {
        Functions.D2D1CreateFactory(type, typeof(T).GUID, options.GetValuePointer(), out var unk).ThrowOnError();
    ...
    public static IComObject<T> D2D1CreateDevice<T>(IDXGIDevice dxgiDevice, D2D1_CREATION_PROPERTIES? creationProperties = null) where T : ID2D1Device
    {
        ...
        Functions.D2D1CreateDevice(dxgiDevice, creationProperties.GetValuePointer(), out var device).ThrowOnError();
    ...
    public static IComObject<T> D2D1CreateDeviceContext<T>(IDXGISurface surface, D2D1_CREATION_PROPERTIES? creationProperties = null)
    {
        ...
        Functions.D2D1CreateDeviceContext(surface, creationProperties.GetValuePointer(), out var deviceContext).ThrowOnError();
