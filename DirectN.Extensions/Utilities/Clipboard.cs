...
public static class Clipboard
{
    ...
    public static HRESULT TryGet<T>(this IDataObject? dataObject, ushort format, out T value) where T : unmanaged
    ...
    public static T Get<T>(this IDataObject? dataObject, ushort format, T defaultValue) where T : unmanaged
    {
    ...
    public static HRESULT TryGet(this IDataObject? dataObject, ushort format, int index, out byte[]? value)
    {
        if (dataObject is null)
        {
            value = default;
    ...
    public static HRESULT TryGet(this IDataObject? dataObject, ushort format, int index, out Stream? stream)
    {
        if (dataObject is null)
        {
            stream = null;
    ...
    public static HRESULT Set(this IDataObject dataObject, ushort format, bool throwOnError = true)
    {
        if (dataObject is null)
            return Constants.E_POINTER;
