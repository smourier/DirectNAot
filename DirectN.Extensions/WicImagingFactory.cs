...
public static class WicImagingFactory
{
    ...
    public static IComObject<IWICBitmap> CreateBitmap(uint width, uint height, Guid pixelFormat, WICBitmapCreateCacheOption option = WICBitmapCreateCacheOption.WICBitmapCacheOnLoad) => WithFactory(f => f.CreateBitmap(width, height, pixelFormat, option));
    ...
    public static IComObject<IWICBitmap> CreateBitmapFromMemory(uint width, uint height, Guid pixelFormat, uint stride, uint bufferSize, nint buffer) => WithFactory(f => f.CreateBitmapFromMemory(width, height, pixelFormat, stride, bufferSize, buffer));
    public static IComObject<IWICBitmap> CreateBitmapFromMemory(uint width, uint height, Guid pixelFormat, uint stride, ReadOnlySpan<byte> buffer) { using var factory = Create()!; return factory.CreateBitmapFromMemory(width, height, pixelFormat, stride, buffer); }
