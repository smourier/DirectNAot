...
public static class WicImagingFactory
{
    ...
    public static IComObject<IWICBitmapEncoder> CreateEncoder(Guid containerFormat, Guid? guidVendor) => WithFactory(f => f.CreateEncoder(containerFormat, guidVendor));
