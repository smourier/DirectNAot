...
{
    public static IReadOnlyList<DWriteLocalizedString> GetNames(this IComObject<IDWriteLocalizedStrings> strings) => GetNames(strings?.Object!);
    ...
    public static IReadOnlyList<DWriteLocalizedString> GetNames(this IComObject<IDWriteStringList> strings) => GetNames(strings?.Object!);
    public static IReadOnlyList<DWriteLocalizedString> GetNames(this IDWriteStringList strings)
    {
        ArgumentNullException.ThrowIfNull(strings);
        var list = new List<DWriteLocalizedString>((int)strings.GetCount());
        for (var i = 0; i < list.Capacity; i++)
