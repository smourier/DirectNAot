...
{
    public static void ExecuteCommandLists(this IComObject<ID3D12CommandQueue> queue, IEnumerable<IComObject<ID3D12CommandList>> lists) => ExecuteCommandLists(queue?.Object!, lists.Select(i => i.Object));
